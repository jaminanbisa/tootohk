...
class Preview extends tootoModules.ViewModule {
  constructor() {
    super();
    tootoFrontend.on('components:init', () => this.onFrontendComponentsInit());
  }
  createDocumentsHandles() {
    jQuery.each(tootoFrontend.documentsManager.documents, (index, document) => {
      ...
      (0, _documentHandle.default)({
        ...
        title,
        id
      }, _documentHandle.EDIT_CONTEXT, null, '.tooto-' + id);
    });
  }
  onFrontendComponentsInit() {
    this.createDocumentsHandles();
    tooto.on('document:loaded', () => this.createDocumentsHandles());
  }
}
exports["default"] = Preview;
window.tootoProPreview = new Preview();
})();
