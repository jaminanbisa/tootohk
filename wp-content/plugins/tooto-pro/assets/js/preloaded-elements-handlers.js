...
"use strict";
(self["webpackChunktooto_pro"] = self["webpackChunktooto_pro"] || []).push([["preloaded-elements-handlers"],{
...
tootoProFrontend.on('tooto-pro/modules/init:before', () => {
  tootoFrontend.hooks.addFilter('tooto-pro/frontend/handlers', extendDefaultHandlers);
});
...
exports["default"] = void 0;
if (window.tootoCommon) {
  window.tootoCommon.helpers.softDeprecated('Scroll util from "/dev/js/frontend/utils/scroll"', '3.1.0', 'tootoModules.utils.Scroll');
}
var _default = tootoModules.utils.Scroll;
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('animated-headline', _animatedHeadlines.default);
  }
}
exports["default"] = _default;
...
exports["default"] = void 0;
var _scroll = _interopRequireDefault(__webpack_require__(/*! tooto-pro/frontend/utils/scroll */ "../assets/dev/js/frontend/utils/scroll.js"));
var _default = tootoModules.frontend.handlers.Base.extend({
  ...
  getDefaultSettings() {
    ...
    settings.selectors = {
      headline: '.tooto-headline',
      dynamicWrapper: '.tooto-headline-dynamic-wrapper',
      dynamicText: '.tooto-headline-dynamic-text'
    };
    settings.classes = {
      dynamicText: 'tooto-headline-dynamic-text',
      dynamicLetter: 'tooto-headline-dynamic-letter',
      textActive: 'tooto-headline-text-active',
      textInactive: 'tooto-headline-text-inactive',
      letters: 'tooto-headline-letters',
      animationIn: 'tooto-headline-animation-in',
      typeSelected: 'tooto-headline-typing-selected',
  ...
  switchWord($oldWord, $newWord) {
    $oldWord.removeClass('tooto-headline-text-active').addClass('tooto-headline-text-inactive');
    $newWord.removeClass('tooto-headline-text-inactive').addClass('tooto-headline-text-active');
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('media-carousel', _mediaCarousel.default);
    tootoFrontend.elementsHandler.attachHandler('testimonial-carousel', _testimonialCarousel.default);
    tootoFrontend.elementsHandler.attachHandler('reviews', _testimonialCarousel.default);
  }
}
exports["default"] = _default;
...
exports["default"] = void 0;
class CarouselBase extends tootoModules.frontend.handlers.SwiperBase {
  getDefaultSettings() {
    return {
      selectors: {
        swiperContainer: '.tooto-main-swiper',
  ...
  getSwiperOptions() {
    ...
    if ('cube' !== this.getEffect()) {
      const breakpointsSettings = {},
        breakpoints = tootoFrontend.config.responsive.activeBreakpoints;
  ...
  getDeviceBreakpointValue(device) {
    if (!this.breakpointsDictionary) {
      const breakpoints = tootoFrontend.config.responsive.activeBreakpoints;
...
class MediaCarousel extends _base.default {
  ...
  getDefaultSettings() {
    ...
    if (this.isSlideshow()) {
      defaultSettings.selectors.thumbsSwiper = '.tooto-thumbnails-swiper';
...
class TestimonialCarousel extends _base.default {
  getDefaultSettings() {
    ...
    Object.keys(tootoFrontend.config.responsive.activeBreakpoints).forEach(breakpointName => {
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('countdown', _countdown.default);
  }
}
exports["default"] = _default;
...
var _default = tootoModules.frontend.handlers.Base.extend({
  cache: null,
  cacheElements() {
    const $countDown = this.$element.find('.tooto-countdown-wrapper');
    this.cache = {
      $countDown,
      timeInterval: null,
      elements: {
        $countdown: $countDown.find('.tooto-countdown-wrapper'),
        $daysSpan: $countDown.find('.tooto-countdown-days'),
        $hoursSpan: $countDown.find('.tooto-countdown-hours'),
        $minutesSpan: $countDown.find('.tooto-countdown-minutes'),
        $secondsSpan: $countDown.find('.tooto-countdown-seconds'),
        $expireMessage: $countDown.parent().find('.tooto-countdown-expire--message')
      },
      data: {
...
class _default extends tootoModules.Module {
  constructor() {
    ...
    tootoFrontend.elementsHandler.attachHandler('form', [...formHandlers, _recaptcha.default, _date.default, _time.default]);
    tootoFrontend.elementsHandler.attachHandler('subscribe', formHandlers);
  }
}
exports["default"] = _default;
...
class FormSteps extends tootoModules.frontend.handlers.Base {
  ...
  extractResponsiveSizeFromSubmitWrapper() {
    ...
    this.elements.$submitWrapper.removeClass((index, className) => {
      sizeClasses = className.match(/tooto-(sm|md)-[0-9]+/g)?.join(' ');
      return sizeClasses;
    });
  ...
  getSubmitButton() {
    ...
    // TODO: When a solution for the conditions will be found, check if can remove the tooto-col-x manipulation.
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('gallery', _handler.default);
  }
}
exports["default"] = _default;
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('hotspot', _hotspot.default);
  }
}
exports["default"] = _default;
...
exports["default"] = void 0;
class Hotspot extends tootoModules.frontend.handlers.Base {
  getDefaultSettings() {
    return {
      selectors: {
        hotspot: '.e-hotspot',
  ...
  onHotspotTriggerEvent(event) {
    const elementTarget = jQuery(event.target),
      ...
      isMobile = 'mobile' === tootoFrontend.getCurrentDeviceMode(),
  ...
  hotspotSequencedAnimation() {
    ...
    const hotspotObserver = tootoModules.utils.Scroll.scrollObserver({
      callback: event => {
        if (event.isInViewport) {
  ...
  onInit() {
    ...
    if (window.tooto) {
      tooto.listenTo(tooto.channels.deviceMode, 'change', () => this.onDeviceModeChange());
    }
  }
  onElementChange(propertyName) {
...
class _default extends tootoModules.Module {
  constructor() {
    ...
    ['post', 'product'].forEach(skinName => {
      tootoFrontend.elementsHandler.attachHandler('loop-grid', _loadMore.default, skinName);
      tootoFrontend.elementsHandler.attachHandler('loop-grid', _loop.default, skinName);
      tootoFrontend.elementsHandler.attachHandler('loop-carousel', _loop.default, skinName);
      tootoFrontend.elementsHandler.attachHandler('loop-carousel', _loopCarousel.default, skinName);
    });
  }
}
exports["default"] = _default;
...
class LoopLoadMore extends _loadMore.default {
  getDefaultSettings() {
    const defaultSettings = super.getDefaultSettings();
    defaultSettings.selectors.postsContainer = '.tooto-loop-container';
    defaultSettings.selectors.postWrapperTag = '.e-loop-item';
    defaultSettings.selectors.loadMoreButton = '.e-loop__load-more .tooto-button';
    defaultSettings.selectors.dynamicStyleElement = 'style[id^="loop-dynamic"]';
    return defaultSettings;
  }
  afterInsertPosts(postsElements, result) {
    super.afterInsertPosts(postsElements);
    if (tootoFrontend.config.experimentalFeatures.e_lazyload) {
...
exports["default"] = void 0;
var _imageCarousel = _interopRequireDefault(__webpack_require__(/*! tooto/assets/dev/js/frontend/handlers/image-carousel */ "../../tooto/assets/dev/js/frontend/handlers/image-carousel.js"));
var _elementHandlers = _interopRequireDefault(__webpack_require__(/*! ./utils/element-handlers */ "../modules/loop-builder/assets/js/frontend/handlers/utils/element-handlers.js"));
class LoopCarousel extends _imageCarousel.default {
  getDefaultSettings() {
    const defaultSettings = super.getDefaultSettings();
    defaultSettings.selectors.carousel = '.tooto-loop-container';
    return defaultSettings;
  }
  getSwiperSettings() {
...
class Loop extends _posts.default {
  ...
  getDefaultSettings() {
    const defaultSettings = super.getDefaultSettings();
    defaultSettings.selectors.post = '.tooto-loop-container .tooto';
    defaultSettings.selectors.postsContainer = '.tooto-loop-container';
    defaultSettings.classes.inPlaceTemplateEditable = 'tooto-in-place-template-editable';
    return defaultSettings;
  }
  ...
  getVerticalSpaceBetween() {
    return tootoProFrontend.utils.controls.getResponsiveControlValue(this.getElementSettings(), 'row_gap', 'size');
  }
  ...
  handleSwiper() {
    ...
    swiper.update();
    this.elementsToRemove = [...this.elementsToRemove, '.swiper-pagination', '.tooto-swiper-button', '.tooto-document-handle'];
  }
  attachEditDocumentHandle() {
    // eslint-disable-next-line computed-property-spacing
    const id = this.getElementSettings('template_id'),
      elementData = tooto.getElementData(tootoFrontend.config.elements.data[this.getModelCID()]),
    ...
    if (this.isFirstEdit()) {
      ...
      this.$element.find('.tooto-swiper-button').remove();
      return;
    }
    (0, _documentHandle.default)({
      ...
      title: __('Template', 'tooto-pro'),
      id
    }, _documentHandle.EDIT_CONTEXT, () => this.onInPlaceEditTemplate(), '.tooto-element-' + this.getID() + ' .tooto-' + id);
  }
  isFirstEdit() {
  ...
  handleCTA() {
    ...
    shadowRoot.appendChild(tootoPro.modules.loopBuilder.getCtaStyles());
    shadowRoot.appendChild(tootoPro.modules.loopBuilder.getCtaContent(this.getWidgetType()));
    const ctaButton = shadowRoot.querySelector('.e-loop-empty-view__box-cta');
    ctaButton.addEventListener('click', () => {
      tootoPro.modules.loopBuilder.createTemplate();
    });
  }
   ...
   */
  doEditorInitAction() {
    tooto.hooks.doAction('editor/widgets/loop-grid/on-init', this);
  }
  onInit() {
    super.onInit(...arguments);
...
function runElementHandlers(elements) {
  [...elements].flatMap(el => [...el.querySelectorAll('.tooto-element')]).forEach(el => tootoFrontend.elementsHandler.runReadyTrigger(el));
}
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('lottie', _handler.default);
  }
}
exports["default"] = _default;
...
exports["default"] = void 0;
class lottieHandler extends tootoModules.frontend.handlers.Base {
  getDefaultSettings() {
    return {
      selectors: {
  ...
  getDefaultElements() {
    ...
    return {
      ...
      $sectionParent: this.$element.closest('.tooto-section'),
      $columnParent: this.$element.closest('.tooto-column')
    };
  }
  onInit() {
    super.onInit(...arguments);
  ...
  lazyloadLottie() {
    ...
    this.intersectionObservers.lazyload.observer = tootoModules.utils.Scroll.scrollObserver({
  ...
  getAnimationPath() {
    ...
    return tootoProFrontend.config.lottie.defaultAnimationUrl;
  }
  setCaption() {
    const lottieSettings = this.getLottieSettings();
  ...
  playAnimationWhenArrivingToViewport() {
    ...
    this.intersectionObservers.animation.observer = tootoModules.utils.Scroll.scrollObserver({
  ...
  getLottieViewportPercentage() {
    return tootoModules.utils.Scroll.getElementViewportPercentage(this.elements.$widgetWrapper, this.getOffset());
  }
  getLottiePagePercentage() {
    return tootoModules.utils.Scroll.getPageScrollPercentage(this.getOffset());
  }
  getLottieViewportHeightPercentage() {
    return tootoModules.utils.Scroll.getPageScrollPercentage(this.getOffset(), window.innerHeight);
  }
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('mega-menu', _megaMenu.default);
  }
}
exports["default"] = _default;
...
exports["default"] = void 0;
class MegaMenu extends tootoModules.frontend.handlers.NestedTabs {
  getDefaultSettings() {
  ...
  isNeedToOpenOnClick() {
    ...
    return this.isEdit || nonMobileDevices.includes(tootoFrontend.getCurrentDeviceMode()) || this.getElementSettings('open_on') !== 'hover';
  }
...
class _default extends tootoModules.Module {
  constructor() {
    ...
    tootoFrontend.elementsHandler.attachHandler('nav-menu', _navMenu.default);
  }
}
exports["default"] = _default;
...
var _eIcons = __webpack_require__(/*! @tooto-pro/e-icons */ "../assets/dev/js/frontend/utils/icons/e-icons.js");
// Temporary solution, when core 3.5.0 will be the minimum version, is should be replaced with @tooto/e-icons.

class _default extends tootoModules.frontend.Document {
  bindEvents() {
    const openSelector = this.getDocumentSettings('open_selector');
    if (openSelector) {
      tootoFrontend.elements.$body.on('click', openSelector, this.showModal.bind(this));
    }
  }
  startTiming() {
  ...
  showModal(avoidMultiple, event) {
    ...
    if (!this.isEdit) {
      if (!tootoFrontend.isWPPreviewMode()) {
        if (this.getStorage('disable')) {
          return;
        }
        if (avoidMultiple && tootoProFrontend.modules.popup.popupPopped && settings.avoid_multiple_popups) {
          return;
        }
      }
    ...
    tootoProFrontend.modules.popup.popupPopped = true;
  ...
  setEntranceAnimation() {
    const $widgetContent = this.getModal().getElements('widgetContent'),
      ...
      newAnimation = tootoFrontend.getCurrentDeviceSetting(settings, 'entrance_animation');
  ...
  handleKeyboardA11y(event) {
    ...
    const onKeyDownPressed = keyDownEvent => {
      ...
      const activeElement = tootoFrontend.elements.window.document.activeElement;
      if (isShiftPressed) {
    ...
    $firstFocusableElement.focus();
    const $window = tootoFrontend.elements.$window;
    $window.on('keydown', onKeyDownPressed).on('tooto/popup/hide', () => {
  ...
  setExitAnimation() {
    const modal = this.getModal(),
      ...
      newAnimation = tootoFrontend.getCurrentDeviceSetting(settings, 'exit_animation'),
      ...
      if (!modal) {
        const settings = this.getDocumentSettings(),
          ...
          triggerPopupEvent = eventType => {
            const event = 'tooto/popup/' + eventType;
            tootoFrontend.elements.$document.trigger(event, [id, this]);

            // TODO: Use `tootoFrontend.utils.events.dispatch` when it's in master.
        ...
        let classes = 'tooto-popup-modal';
        if (settings.classes) {
          classes += ' ' + settings.classes;
        }
        const modalProperties = {
          id: 'tooto-popup-modal-' + id,
          className: classes,
          closeButton: true,
        ...
        if (tootoFrontend.config.experimentalFeatures.e_font_icon_svg) {
        ...
        modal = tootoFrontend.getDialogsManager().createWidget('lightbox', modalProperties);
  ...
  setStorage(key, value, options) {
    tootoFrontend.storage.set(`popup_${this.getSettings('id')}_${key}`, value, options);
  }
  getStorage(key, options) {
    return tootoFrontend.storage.get(`popup_${this.getSettings('id')}_${key}`, options);
  }
  countTimes() {
  ...
  async onInit() {
    ...
    if (!window.DialogsManager) {
      await tootoFrontend.utils.assetsLoader.load('script', 'dialog');
    }
    this.initModal();
    if (this.isEdit) {
      this.showModal();
    ...
    if (tootoFrontend.isWPPreviewMode() && tootoFrontend.config.post.id === this.getSettings('id')) {
      this.showModal();
      return;
    }
    this.startTiming();
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.hooks.addAction('tooto/frontend/documents-manager/init-classes', this.addDocumentClass);
    tootoFrontend.elementsHandler.attachHandler('form', _formsAction.default);
    tootoFrontend.on('components:init', () => this.onFrontendComponentsInit());
    if (!tootoFrontend.isEditMode() && !tootoFrontend.isWPPreviewMode()) {
  ...
  setViewsAndSessions() {
    const pageViews = tootoFrontend.storage.get('pageViews') || 0;
    tootoFrontend.storage.set('pageViews', pageViews + 1);
    const activeSession = tootoFrontend.storage.get('activeSession', {
      session: true
    });
    if (!activeSession) {
      tootoFrontend.storage.set('activeSession', true, {
        session: true
      });
      const sessions = tootoFrontend.storage.get('sessions') || 0;
      tootoFrontend.storage.set('sessions', sessions + 1);
    }
  }
  showPopup(settings) {
    const popup = tootoFrontend.documentsManager.documents[settings.id];
    if (!popup) {
      return;
    }
  ...
  closePopup(settings, event) {
    const popupID = jQuery(event.target).parents('[data-tooto-type="popup"]').data('tootoId');
    if (!popupID) {
      return;
    }
    const document = tootoFrontend.documentsManager.documents[popupID];
  ...
  onFrontendComponentsInit() {
    tootoFrontend.utils.urlActions.addAction('popup:open', settings => this.showPopup(settings));
    tootoFrontend.utils.urlActions.addAction('popup:close', (settings, event) => this.closePopup(settings, event));
  }
}
exports["default"] = _default;
...
class _default extends _base.default {
  ...
  check() {
    ...
    const targetedBrowsers = this.getTimingSetting('browsers_options'),
      browserDetectionFlags = tootoFrontend.utils.environment;
...
class _default extends _base.default {
  ...
  check() {
    return -1 !== this.getTimingSetting('devices').indexOf(tootoFrontend.getCurrentDeviceMode());
  }
}
exports["default"] = _default;
...
class _default extends _base.default {
  ...
  check() {
    const userConfig = tootoFrontend.config.user;
    if (!userConfig) {
      return true;
    }
...
class _default extends _base.default {
  ...
  check() {
    const pageViews = tootoFrontend.storage.get('pageViews'),
      name = this.getName();
...
class _default extends _base.default {
  ...
  check() {
    const sessions = tootoFrontend.storage.get('sessions'),
      name = this.getName();
...
class _default extends _base.default {
  ...
  onPopupHide() {
    window.addEventListener('tooto/popup/hide', () => {
...
class _default extends _base.default {
  ...
  run() {
    tootoFrontend.elements.$body.on('click', this.checkClick);
  }
  destroy() {
    tootoFrontend.elements.$body.off('click', this.checkClick);
  }
}
exports["default"] = _default;
...
class _default extends _base.default {
  ...
  run() {
    tootoFrontend.elements.$window.on('mouseleave', this.detectExitIntent);
  }
  destroy() {
    tootoFrontend.elements.$window.off('mouseleave', this.detectExitIntent);
  }
}
exports["default"] = _default;
...
class _default extends _base.default {
  ...
  run() {
    this.startTimer();
    tootoFrontend.elements.$document.on('keypress mousemove', this.restartTimer);
  }
  startTimer() {
  ...
  destroy() {
    this.clearTimer();
    tootoFrontend.elements.$document.off('keypress mousemove', this.restartTimer);
  }
}
exports["default"] = _default;
...
class _default extends _base.default {
  ...
  run() {
    ...
    this.waypointInstance = tootoFrontend.waypoint($targetElement, this.callback)[0];
  }
  destroy() {
...
class _default extends _base.default {
  ...
  checkScroll() {
    ...
    const fullScroll = tootoFrontend.elements.$document.height() - innerHeight,
  ...
  run() {
    tootoFrontend.elements.$window.on('scroll', this.checkScroll);
  }
  destroy() {
    tootoFrontend.elements.$window.off('scroll', this.checkScroll);
  }
}
exports["default"] = _default;
...
class _default extends tootoModules.Module {
  constructor() {
    ...
    ['classic', 'full_content', 'cards'].forEach(skinName => {
      tootoFrontend.elementsHandler.attachHandler('posts', _loadMore.default, skinName);
    });
    tootoFrontend.elementsHandler.attachHandler('posts', _posts.default, 'classic');
    tootoFrontend.elementsHandler.attachHandler('posts', _posts.default, 'full_content');
    tootoFrontend.elementsHandler.attachHandler('posts', _cards.default, 'cards');
    tootoFrontend.elementsHandler.attachHandler('portfolio', _portfolio.default);
  }
}
exports["default"] = _default;
...
exports["default"] = void 0;
class LoadMore extends tootoModules.frontend.handlers.Base {
  getDefaultSettings() {
    return {
      selectors: {
        postsContainer: '.tooto-posts-container',
        postWrapperTag: 'article',
        loadMoreButton: '.tooto-button',
  ...
  onInit() {
    ...
    this.postId = tootoFrontendConfig.post.id;
  ...
  handleInfiniteScroll() {
    ...
    this.observer = tootoModules.utils.Scroll.scrollObserver({
      callback: event => {
...
var _default = tootoModules.frontend.handlers.Base.extend({
  ...
  bindEvents() {
    tootoFrontend.addListenerOnce(this.getModelCID(), 'resize', this.onWindowResize);
  },
  unbindEvents() {
    tootoFrontend.removeListeners(this.getModelCID(), 'resize', this.onWindowResize);
  },
  getClosureMethodsNames() {
  ...
  setColsCountSettings() {
    const settings = this.getElementSettings(),
      ...
      colsCount = tootoProFrontend.utils.controls.getResponsiveControlValue(settings, `${skinPrefix}columns`);
  ...
  getVerticalSpaceBetween() {
    ...
    let verticalSpaceBetween = tootoProFrontend.utils.controls.getResponsiveControlValue(this.getElementSettings(), `${this.getSkinPrefix()}row_gap`, 'size');
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('share-buttons', _shareButtons.default);
  }
}
exports["default"] = _default;
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('slides', _slides.default);
  }
}
exports["default"] = _default;
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('facebook-button', _facebook.default);
    tootoFrontend.elementsHandler.attachHandler('facebook-comments', _facebook.default);
    tootoFrontend.elementsHandler.attachHandler('facebook-embed', _facebook.default);
    tootoFrontend.elementsHandler.attachHandler('facebook-page', _facebook.default);
  }
}
exports["default"] = _default;
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('table-of-contents', _tableOfContents.default);
  }
}
exports["default"] = _default;
...
exports["default"] = void 0;
class TOCHandler extends tootoModules.frontend.handlers.Base {
  getDefaultSettings() {
    const elementSettings = this.getElementSettings(),
      listWrapperTag = 'numbers' === elementSettings.marker_view ? 'ol' : 'ul';
    return {
      selectors: {
        widgetContainer: '.tooto-widget-container',
        postContentContainer: '.tooto:not([data-tooto-type="header"]):not([data-tooto-type="footer"]):not([data-tooto-type="popup"])',
        expandButton: '.tooto-toc__toggle-button--expand',
        collapseButton: '.tooto-toc__toggle-button--collapse',
        body: '.tooto-toc__body',
        headerTitle: '.tooto-toc__header-title'
      },
      classes: {
        anchor: 'tooto-menu-anchor',
        listWrapper: 'tooto-toc__list-wrapper',
        listItem: 'tooto-toc__list-item',
        listTextWrapper: 'tooto-toc__list-item-text-wrapper',
        firstLevelListItem: 'tooto-toc__top-level',
        listItemText: 'tooto-toc__list-item-text',
        activeItem: 'tooto-item-active',
        headingAnchor: 'tooto-toc__heading-anchor',
        collapsed: 'tooto-toc--collapsed'
      },
      listWrapperTag
    };
  }
  ...
  getContainer() {
    ...
    const $documentWrapper = this.$element.parents('.tooto');

    // If the TOC container is a popup, only scan the popup for headings
    if ('popup' === $documentWrapper.attr('data-tooto-type')) {
  ...
  followAnchor($element, index) {
    ...
    tootoFrontend.waypoint($anchor, direction => {
      if (this.itemClicked) {
        return;
      }
  ...
  populateTOC() {
    ...
    this.$listItemTexts = this.$element.find('.tooto-toc__list-item-text');
  ...
  getNestedLevel(level) {
    ...
    if (icon) {
      ...
      if (tootoFrontend.config.experimentalFeatures.e_font_icon_svg && !tootoFrontend.isEditMode()) {
  ...
  handleNoHeadingsFound() {
    const noHeadingsText = __('No headings were found on this page.', 'tooto-pro');
    return this.elements.$tocBody.html(noHeadingsText);
  }
  collapseBodyListener() {
    const activeBreakpoints = tootoFrontend.breakpoints.getActiveBreakpointsList({
      withDesktop: true
    });
    const minimizedOn = this.getElementSettings('minimized_on'),
      currentDeviceMode = tootoFrontend.getCurrentDeviceMode(),
  ...
  getHeadingAnchorLink(index, classes) {
    const headingID = this.elements.$headings[index].id,
      wrapperID = this.elements.$headings[index].closest('.tooto-widget').id;
    let anchorLink = '';
    if (headingID) {
...
class _default extends tootoModules.Module {
  constructor() {
    ...
    ['archive_classic', 'archive_full_content', 'archive_cards'].forEach(skinName => {
      tootoFrontend.elementsHandler.attachHandler('archive-posts', _archivePostsLoadMore.default, skinName);
    });
    tootoFrontend.elementsHandler.attachHandler('archive-posts', _archivePostsSkinClassic.default, 'archive_classic');
    tootoFrontend.elementsHandler.attachHandler('archive-posts', _archivePostsSkinClassic.default, 'archive_full_content');
    tootoFrontend.elementsHandler.attachHandler('archive-posts', _archivePostsSkinCards.default, 'archive_cards');
    jQuery(function () {
      // Go to tooto element - if the URL is something like http://domain.com/any-page?preview=true&theme_template_id=6479
      var match = location.search.match(/theme_template_id=(\d*)/),
        $element = match ? jQuery('.tooto-' + match[1]) : [];
      if ($element.length) {
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('search-form', _searchForm.default);
  }
}
exports["default"] = _default;
...
class _default extends tootoModules.Module {
  constructor() {
    super();
    tootoFrontend.elementsHandler.attachHandler('woocommerce-menu-cart', _menuCart.default);
    tootoFrontend.elementsHandler.attachHandler('woocommerce-purchase-summary', _purchaseSummary.default);
    tootoFrontend.elementsHandler.attachHandler('woocommerce-checkout-page', _checkoutPage.default);
    tootoFrontend.elementsHandler.attachHandler('woocommerce-cart', _cart.default);
    tootoFrontend.elementsHandler.attachHandler('woocommerce-my-account', _myAccount.default);
    tootoFrontend.elementsHandler.attachHandler('woocommerce-notices', _notices.default);
    tootoFrontend.elementsHandler.attachHandler('woocommerce-product-add-to-cart', _productAddToCart.default);
    ...
    if (tootoFrontend.isEditMode()) {
      tootoFrontend.on('components:init', () => {
        if (!tootoFrontend.elements.$body.find('.tooto-widget-woocommerce-cart').length) {
          tootoFrontend.elements.$body.append('<div class="woocommerce-cart-form">');
        }
      });
    }
  }
...
exports["default"] = void 0;
class Base extends tootoModules.frontend.handlers.Base {
  getDefaultSettings() {
    return {
      selectors: {
  ...
  bindEvents() {
    ...
    tootoFrontend.elements.$document.on('select2:open', event => {
  ...
  activateStickyRightColumn() {
    const elementSettings = this.getElementSettings(),
      $wpAdminBar = tootoFrontend.elements.$wpAdminBar,
      classes = this.getSettings('classes');
   ...
   * In tooto's Order Summary design, the product name and purchase note are displayed un-separated.
  ...
  /**
   * `tootoPageId` and `tootoWidgetId` are added to the url in the `_wp_http_referer` input which is then
  ...
  updateWpReferers() {
    ...
    url.searchParams.set('tootoPageId', tootoFrontend.config.post.id);
    url.searchParams.set('tootoWidgetId', this.getID());
...
class Cart extends _base.default {
  ...
  bindEvents() {
    super.bindEvents();
    const selectors = this.getSettings('selectors');
    tootoFrontend.elements.$body.on('wc_fragments_refreshed', () => this.applyButtonsHoverAnimation());
    if ('yes' === this.getElementSettings('update_cart_automatically')) {
      this.$element.on('input', selectors.quantityInput, () => this.updateCart());
    }
    tootoFrontend.elements.$body.on('wc_fragments_loaded wc_fragments_refreshed', () => {
      this.updateWpReferers();
      if (tootoFrontend.isEditMode() || tootoFrontend.isWPPreviewMode()) {
        this.disableActions();
      }
    });
    tootoFrontend.elements.$body.on('added_to_cart', function (e, data) {
  ...
  onElementChange(propertyName) {
    ...
    if ('additional_template_select' === propertyName) {
      tootoPro.modules.woocommerce.onTemplateIdChange('additional_template_select');
    }
  }
  onDestroy() {
  ...
  applyButtonsHoverAnimation() {
    ...
    if (elementSettings.checkout_button_hover_animation) {
      ...
      jQuery('.checkout-button').addClass('tooto-animation-' + elementSettings.checkout_button_hover_animation);
    }
    if (elementSettings.forms_buttons_hover_animation) {
      // This element is recaptured every time because the cart markup can refresh
      jQuery('.shop_table .button').addClass('tooto-animation-' + elementSettings.forms_buttons_hover_animation);
    }
  }
  ...
  hideHiddenInputsParentElements() {
    if (this.isEdit) {
      if (this.elements.$hiddenInput) {
        this.elements.$hiddenInput.parent('.form-row').addClass('tooto-hidden');
      }
    }
  }
}
...
class Checkout extends _base.default {
  getDefaultSettings() {
    ...
    return {
      selectors: {
        ...defaultSettings.selectors,
        container: '.tooto-widget-woocommerce-checkout-page',
  ...
  bindEvents() {
    ...
    tootoFrontend.elements.$body.on('updated_checkout', () => {
  ...
  applyPurchaseButtonHoverAnimation() {
    ...
    if (purchaseButtonHoverAnimation) {
      ...
      jQuery('#place_order').addClass('tooto-animation-' + purchaseButtonHoverAnimation);
    }
  }
  applyCoupon() {
    ...
    jQuery.ajax({
      ...
      success(code) {
        ...
        if (code) {
          ...
          tootoFrontend.elements.$body.trigger('applied_coupon_in_checkout', [data.coupon_code]);
          tootoFrontend.elements.$body.trigger('update_checkout', {
  ...
  loginUser() {
    ...
    const data = {
      action: 'tooto_woocommerce_checkout_login_user',
    ...
    jQuery.ajax({
      ...
      success(code) {
        ...
        if (code.logged_in) {
          ...
          tootoFrontend.elements.$body.trigger('checkout_error', [code.message]);
        }
      }
    });
  }
...
class _default extends tootoModules.frontend.handlers.Base {
  getDefaultSettings() {
    return {
      selectors: {
        ...
        productList: '.tooto-menu-cart__products'
      },
      classes: {
  ...
  refreshFragments(eventType) {
    ...
    if (tootoFrontend.isEditMode() && tootoPro.modules.woocommerce.didManuallyTriggerAddToCartEvent(data)) {
      return false;
    }
    const templatesInPage = [];
    jQuery.each(tootoFrontend.documentsManager.documents, index => {
      templatesInPage.push(index);
    });
    jQuery.ajax({
      type: 'POST',
      url: tootoProFrontend.config.ajaxurl,
      context: this,
      data: {
        action: 'tooto_menu_cart_fragments',
        templates: templatesInPage,
        _nonce: tootoProFrontendConfig.woocommerce.menu_cart.fragments_nonce,
        is_editor: tootoFrontend.isEditMode()
      },
      success(successData) {
  ...
  bindEvents() {
    const menuCart = tootoProFrontend.config.woocommerce.menu_cart,
    ...
    tootoFrontend.elements.$body.on('wc_fragments_refreshed removed_from_cart added_to_cart', (event, data) => this.refreshFragments(event.type, data));

    // Govern the height of the mini-cart dropdown.
    tootoFrontend.addListenerOnce(this.getUniqueHandlerID() + '_window_resize_dropdown', 'resize', () => this.governDropdownHeight());
    tootoFrontend.elements.$body.on('wc_fragments_loaded wc_fragments_refreshed', () => this.governDropdownHeight());
  }
  unbindEvents() {
    tootoFrontend.removeListeners(this.getUniqueHandlerID() + '_window_resize_dropdown', 'resize');
  }
  onInit() {
    super.onInit();
     ...
     */
    if (tootoProFrontend.config.woocommerce.productAddedToCart) {
      this.automaticallyOpenCart();
    }
...
class MyAccountHandler extends _base.default {
  ...
  toggleEndpointClasses() {
    ...
    if ('dashboard' === this.currentPage && this.elements.$contentWrapper.find('.tooto').length) {
  ...
  applyButtonsHoverAnimation() {
    const elementSettings = this.getElementSettings();
    if (elementSettings.forms_buttons_hover_animation) {
      this.$element.find('.woocommerce button.button,  #add_payment_method #payment #place_order').addClass('tooto-animation-' + elementSettings.forms_buttons_hover_animation);
    }
    if (elementSettings.tables_button_hover_animation) {
      this.$element.find('.order-again .button, td .button, .woocommerce-pagination .button').addClass('tooto-animation-' + elementSettings.tables_button_hover_animation);
    }
  }
  ...
  onElementChange(propertyName) {
    ...
    if ('customize_dashboard_select' === propertyName) {
      tootoPro.modules.woocommerce.onTemplateIdChange('customize_dashboard_select');
    }
  }
  bindEvents() {
    super.bindEvents();
    ...
    tootoFrontend.elements.$body.on('keyup change', '.register #reg_password', () => {
      this.equalizeElementHeights();
    });
  }
  onInit() {
...
class _default extends tootoModules.frontend.handlers.Base {
  ...
  getDefaultElements() {
    const selectors = this.getSettings('selectors');
    return {
      $documentScrollToElements: tootoFrontend.elements.$document.find('html, body'),
      $woocommerceCheckoutForm: tootoFrontend.elements.$body.find('.form.checkout'),
  ...
  moveNotices() {
    ...
    const selectors = this.getSettings('selectors');
    let $notices = tootoFrontend.elements.$body.find(selectors.woocommerceNotices);
    if (tootoFrontend.isEditMode() || tootoFrontend.isWPPreviewMode()) {
  ...
  bindEvents() {
    tootoFrontend.elements.$body.on('updated_wc_div updated_checkout updated_cart_totals applied_coupon removed_coupon applied_coupon_in_checkout removed_coupon_in_checkout checkout_error', () => this.moveNotices(true));
  }
}
exports["default"] = _default;
...
class ProductAddToCart extends _base.default {
  ...
  bindEvents() {
    ...
    tootoFrontend.elements.$body.off('added_to_cart.tooto-woocommerce-product-add-to-cart');
    tootoFrontend.elements.$body.on('added_to_cart.tooto-woocommerce-product-add-to-cart', (e, fragments, cartHash, $button) => {
...
class PurchaseSummaryHandler extends _base.default {
  getDefaultSettings() {
    return {
      selectors: {
        container: '.tooto-widget-woocommerce-purchase-summary',
        address: 'address',
  ...
  applyButtonsHoverAnimation() {
    ...
    if (elementSettings.order_details_button_hover_animation) {
      this.$element.find('.order-again .button, td .button').addClass('tooto-animation-' + elementSettings.order_details_button_hover_animation);
    }
  }
  onInit() {
    super.onInit(...arguments);
...
/***/ "../../tooto/assets/dev/js/frontend/handlers/image-carousel.js":
/*!*************************************************************************!*\
  !*** ../../tooto/assets/dev/js/frontend/handlers/image-carousel.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
