...
class Module extends tootoModules.Module {
  onInit() {
...
var _tootoFontManager = _interopRequireDefault(__webpack_require__(/*! ./admin/tooto-font-manager */ "../modules/assets-manager/assets/js/admin/tooto-font-manager.js"));
var _tootoCustomIcons = _interopRequireDefault(__webpack_require__(/*! ./admin/tooto-custom-icons */ "../modules/assets-manager/assets/js/admin/tooto-custom-icons.js"));
module.exports = function () {
  const TypekitAdmin = __webpack_require__(/*! ./admin/typekit */ "../modules/assets-manager/assets/js/admin/typekit.js"),
    CustomIcon = _tootoCustomIcons.default,
  ...
  this.fontManager = new _tootoFontManager.default();
...
exports["default"] = void 0;
class CustomAssetsBase extends tootoModules.ViewModule {
  showAlertDialog(id, message) {
    ...
    if (!this.alertWidget) {
      this.alertWidget = tootoCommon.dialogsManager.createWidget('alert', alertData);
    }
...
/***/ "../modules/assets-manager/assets/js/admin/tooto-custom-icons.js":
/*!***************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/tooto-custom-icons.js ***!
  \***************************************************************************/
...
var _tootoProDropzone = _interopRequireDefault(__webpack_require__(/*! ./fields/tooto-pro-dropzone */ "../modules/assets-manager/assets/js/admin/fields/tooto-pro-dropzone.js"));
class CustomIcons extends _customAssetsBase.default {
  getDefaultSettings() {
    return {
      fields: {
        dropzone: _tootoProDropzone.default
      },
      classes: {
        editPageClass: 'post-type-tooto_icons',
        editPhp: 'edit-php',
        hasIcons: 'tooto--has-icons'
      },
      selectors: {
        editPageClass: 'post-type-tooto_icons',
        title: '#title',
        metaboxContainer: '#tooto-custom-icons-metabox',
        metabox: '.tooto-custom-icons-metabox',
        closeHandle: 'button.handlediv',
        iconsTemplate: '#tooto-icons-template',
        dataInput: '#tooto_custom_icon_set_config',
        dropzone: '.zip_upload',
        ...
        iconSetConfigInput: '#tooto_custom_icon_set_config'
      },
      templates: {
        icon: '<li><div class="icon"><i class="{{icon}}"></i><div class="icon-name">{{label}}</div></div></li>',
        header: jQuery('#tooto-custom-icons-template-header').html(),
        footer: jQuery('#tooto-custom-icons-template-footer').html(),
        duplicatePrefix: jQuery('#tooto-custom-icons-template-duplicate-prefix').html()
      },
      notice: __('Upload an icon set to publish.', 'tooto-pro')
    };
  }
  getDefaultElements() {
    const elements = {},
  ...
  prepareIconName(icon) {
    ...
    return tootoCommon.helpers.upperCaseWords(iconName);
  }
  getCreatedOn() {
    const {
      $dayInput,
  ...
  enqueueCSS(url) {
    if (!tootoCommon.elements.$document.find('link[href="' + url + '"]').length) {
      tootoCommon.elements.$document.find('link').last().after('<link href="' + url + '" rel="stylesheet" type="text/css">');
    }
  }
  setData(data) {
  ...
  renderIconList(config) {
    ...
    return config.icons.map(icon => {
      ...
      return tootoCommon.compileTemplate(iconTemplate, data);
    }).join('\n');
  }
  renderIcons(config) {
    const {
    ...
    $metabox.html('');
    $metaboxContainer.prepend(tootoCommon.compileTemplate(header, config));
    $metabox.append('<ul>' + this.renderIconList(config) + '</ul>');
    $metaboxContainer.append(tootoCommon.compileTemplate(footer, this.getCreatedOn()));
  }
  onTitleInput(event) {
...
/***/ "../modules/assets-manager/assets/js/admin/tooto-font-manager.js":
/*!***************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/tooto-font-manager.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = void 0;
var _customAssetsBase = _interopRequireDefault(__webpack_require__(/*! ./custom-assets-base */ "../modules/assets-manager/assets/js/admin/custom-assets-base.js"));
var _tootoProUpload = _interopRequireDefault(__webpack_require__(/*! ./fields/tooto-pro-upload */ "../modules/assets-manager/assets/js/admin/fields/tooto-pro-upload.js"));
var _tootoProRepeater = _interopRequireDefault(__webpack_require__(/*! ./fields/tooto-pro-repeater */ "../modules/assets-manager/assets/js/admin/fields/tooto-pro-repeater.js"));
class CustomFontsManager extends _customAssetsBase.default {
  getDefaultSettings() {
    return {
      fields: {
        upload: _tootoProUpload.default,
        repeater: _tootoProRepeater.default
      },
      selectors: {
        editPageClass: 'post-type-tooto_font',
        title: '#title',
        ...
        customFontsMetaBox: '#tooto-font-custommetabox',
        closeHandle: 'button.handlediv',
        toolbar: '.tooto-field-toolbar',
        inlinePreview: '.inline-preview',
        fileUrlInput: '.tooto-field-file input[type="text"]',
        postForm: '#post',
        publishButton: '#publish',
        publishButtonSpinner: '#publishing-action > .spinner'
      },
      notice: __('Choose a font to publish.', 'tooto-pro'),
  ...
  updateRowLabel(event, $table) {
    ...
    return this.renderTemplate(fontLabelTemplate, {
      ...
      preview: '<span style="' + previewStyle.styleAttribute + '">tooto is making the web beautiful</span>',
      toolbar: toolbarHtml
    });
  }
...
/***/ "../modules/assets-manager/assets/js/admin/fields/tooto-pro-dropzone.js":
/*!**********************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/fields/tooto-pro-dropzone.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports["default"] = void 0;
class DropZoneField extends tootoModules.ViewModule {
  getDefaultSettings() {
    const baseSelector = '.tooto-dropzone-field';
    return {
      droppedFiles: false,
      selectors: {
        ...
        browseButton: baseSelector + ' .tooto--dropzone--upload__browse',
        postId: '#post_ID'
      },
      classes: {
        drag: 'is-dragover',
  ...
  onInit() {
    super.onInit();
    tootoCommon.elements.$document.trigger('onDropzoneLoaded', [this]);
  }
}
...
/***/ "../modules/assets-manager/assets/js/admin/fields/tooto-pro-repeater.js":
/*!**********************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/fields/tooto-pro-repeater.js ***!
  \**********************************************************************************/
/***/ ((module) => {
...
module.exports = {
  selectors: {
    ...
    repeaterField: '.tooto-field-repeater'
  },
  counters: [],
...
/***/ "../modules/assets-manager/assets/js/admin/fields/tooto-pro-upload.js":
/*!********************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/fields/tooto-pro-upload.js ***!
  \********************************************************************************/
/***/ ((module) => {
...
module.exports = {
  ...
  fileFrame: [],
  selectors: {
    uploadBtnClass: 'tooto-upload-btn',
    clearBtnClass: 'tooto-upload-clear-btn',
    uploadBtn: '.tooto-upload-btn',
    clearBtn: '.tooto-upload-clear-btn',
    inputURLField: '.tooto-field-file input[type="text"]'
  },
  hasValue() {
  ...
  setUploadParams(ext, name) {
    ...
    uploader.param('uploadTypeCaller', 'tooto-admin-font-upload');
...
class _default extends tootoModules.ViewModule {
  getDefaultSettings() {
    return {
      selectors: {
        button: '#tooto_pro_fa_pro_validate_button',
        kitIdField: '#tooto_font_awesome_pro_kit_id'
      }
    };
  }
  getDefaultElements() {
...
module.exports = function () {
  ...
  self.cacheElements = function () {
    this.cache = {
      $button: jQuery('#tooto_pro_typekit_validate_button'),
      $kitIdField: jQuery('#tooto_typekit-kit-id'),
      $dataLabelSpan: jQuery('.tooto-pro-typekit-data')
    };
  };
  ...
  self.fetchFonts = function () {
    ...
    jQuery.post(ajaxurl, {
      action: 'tooto_pro_admin_fetch_fonts',
      kit_id: kitID,
...
module.exports = function (key, fieldID) {
  ...
  self.cacheElements = function () {
    this.cache = {
      $button: jQuery('#tooto_pro_' + key + '_button'),
      $apiKeyField: jQuery('#tooto_pro_' + key),
      $apiUrlField: jQuery('#tooto_pro_' + fieldID)
    };
  };
  self.bindEvents = function () {
    this.cache.$button.on('click', function (event) {
...
module.exports = function () {
  var self = this;
  self.init = function () {
    jQuery(document).on('change', '.tooto-widget-template-select', function () {
      var $this = jQuery(this),
        templateID = $this.val(),
        $editButton = $this.parents('p').find('.tooto-edit-template'),
        type = $this.find('[value="' + templateID + '"]').data('type');
      if ('page' !== type) {
        // 'widget' is editable only from tooto page
        $editButton.hide();
        return;
      }
...
class _default extends tootoModules.Module {
  constructor() {
    var _tootoModules$adm;
    super();
    if (!((_tootoModules$adm = tootoModules.admin) !== null && _tootoModules$adm !== void 0 && _tootoModules$adm.MenuHandler)) {
      return;
    }
    new tootoModules.admin.MenuHandler({
      path: 'edit.php?post_type=tooto_library&tabs_group=popup&tooto_library_type=popup'
    });
  }
}
exports["default"] = _default;
...
module.exports = function () {
  ...
  self.cacheElements = function () {
    this.cache = {
      $checkBox: jQuery('input[name="tooto_exclude_user_roles[]"]'),
      $advanced: jQuery('#tooto_advanced_role_manager')
    };
  };
  self.bindEvents = function () {
  ...
  self.init = function () {
    if (!jQuery('body').hasClass('tooto_page_tooto-role-manager')) {
      return;
    }
    this.cacheElements();
    this.bindEvents();
...
module.exports = function () {
  var selectors = {
    templateTypeInput: '#tooto-new-template__form__template-type',
    locationWrapper: '#tooto-new-template__form__location__wrapper',
    postTypeWrapper: '#tooto-new-template__form__post-type__wrapper'
  };
  var elements = {
  ...
  var setElements = function () {
    jQuery.each(selectors, function (key, selector) {
      key = '$' + key;
      elements[key] = tootoNewTemplate.layout.getModal().getElements('content').find(selector);
    });
  };
  ...
  this.init = function () {
    if (!window.tootoNewTemplate) {
      return;
    }

    // Make sure the modal has already been initialized
    tootoNewTemplate.layout.getModal();
    run();
  };
...
jQuery(function () {
  tootoProAdmin.roleManager.advancedRoleManager.init();
});
})();
