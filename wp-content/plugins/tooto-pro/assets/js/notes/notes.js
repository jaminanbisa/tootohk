...
var EComponent = /*#__PURE__*/function (_$e$modules$Component) {
  ...
  function EComponent(args) {
    ...
    window.addEventListener('message', function (event) {
      if (event.data.name !== 'tooto-pro/notes/config') {
        return;
      }
    ...
    window.addEventListener('DOMContentLoaded', function () {
      var adminBarButton = document.getElementById('wp-admin-bar-tooto_notes');
      if (!adminBarButton) {
        return;
      }
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EComponent, [{
    ...
    value: function updateEditorState(mode) {
      ...
      switch (mode) {
        case this.constructor.NOTES_MODE_OPEN:
          tooto.getPanelView().modeSwitcher.currentView.setMode('preview');
          tooto.channels.dataEditMode.once('switch', function () {
            if (!_this2.isOpen) {
              return;
            }
            window.top.$e.run('notes/close');
        ...
        case this.constructor.NOTES_MODE_CLOSE:
          tooto.getPanelView().modeSwitcher.currentView.setMode('editor');
          break;
        default:
    ...
    value: function getPreviewFrame() {
      return this.isInEditor() ? tooto.$preview[0].contentWindow : window;
    }
  }, {
    ...
    value: function contextMenuNotesGroup() {
      ...
      elTypes.forEach(function (type) {
        tooto.hooks.addFilter("elements/".concat(type, "/contextMenuGroups"), _this3.contextMenuAddGroup);
      });
    }
