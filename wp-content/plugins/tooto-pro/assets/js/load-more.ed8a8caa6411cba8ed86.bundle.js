...
(self["webpackChunktooto_pro"] = self["webpackChunktooto_pro"] || []).push([["load-more"],{
...
class LoadMore extends tootoModules.frontend.handlers.Base {
  ...
  onInit() {
    ...
    this.postId = tootoFrontendConfig.post.id; // Set the current page and last page for handling the load more post and when no more posts to show.
  ...
  handleSuccessFetch(result) {
    ...
    const posts = html.querySelectorAll('.tooto-posts-container > article'); // Converting HTMLCollection to an Array and iterate it.
  ...
  handlePostsQuery() {
    ...
    this.currentPage++;
    const restUrl = `${tootoProFrontendConfig.urls.rest}tooto-pro/v1/posts-widget?post_id=${this.postId}&element_id=${this.elementId}&page=${this.currentPage}`;
