...
"use strict";
(self["webpackChunktooto_pro"] = self["webpackChunktooto_pro"] || []).push([["modules_query-control_assets_js_editor_template-query-control_js"],{
...
class TemplateQueryControl extends _queryControl.default {
  ...
  createTemplate() {
    if (!this.confirmSaveBeforeTemplateCreateDialog) {
      this.confirmSaveBeforeTemplateCreateDialog = tootoCommon.dialogsManager.createWidget('confirm', {
        id: 'e-confirm-save-before-template-create',
        headerMessage: __('Save Changes', 'tooto-pro'),
        message: __('Would you like to save the changes you\'ve made?', 'tooto-pro'),
        position: {
          my: 'center center',
          at: 'center center'
        },
  ...
  getSelect2Placeholder() {
    return {
      id: '',
      text: __('Start typing its name', 'tooto-pro')
    };
  }
}
