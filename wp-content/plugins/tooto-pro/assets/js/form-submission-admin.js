...
function BulkActionSelect(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("form", {
  ...
  }, __('Select bulk action', 'tooto-pro')), /*#__PURE__*/_react.default.createElement("select", {
    name: "action",
    value: value,
    ...
    value: "",
    disabled: true
  }, __('Bulk actions', 'tooto-pro')), props.actions.map(action => {
...
function DateFilter(props) {
  ...
  const options = useMemo(() => {
    ...
    return [{
      ...
      label: __('Last 7 days', 'tooto-pro'),
      value: 'last7',
      filter: {
        before: null,
      ...
      label: __('Last 30 days', 'tooto-pro'),
      value: 'last_30',
      filter: {
        before: null,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, props.label && /*#__PURE__*/_react.default.createElement("label", {
    ...
    type: "date",
    "aria-label": __('Start Date', 'tooto-pro'),
    ...
    type: "date",
    "aria-label": __('End Date', 'tooto-pro'),
...
const buttonContentOptions = {
  [_useExport.EXPORT_MODE_ALL]: __('Export All to CSV', 'tooto-pro'),
  [_useExport.EXPORT_MODE_FILTERED]: __('Export Filtered to CSV', 'tooto-pro'),
  [_useExport.EXPORT_MODE_SELECTED]: __('Export Selected to CSV', 'tooto-pro')
};
function ExportButton(props) {
  ...
  }), " \xA0", /*#__PURE__*/_react.default.createElement("span", null, " ", ProgressPercentage, "% "), " \xA0", __('Click to Cancel', 'tooto-pro')) : buttonContentOptions[props.mode]);
}
...
function FormActionsLog(props) {
  return /*#__PURE__*/_react.default.createElement(_postBox.default, {
    header: /*#__PURE__*/_react.default.createElement("h2", null, __('Actions Log', 'tooto-pro'))
  ...
  }, " ", __('No form actions.', 'tooto-pro'), " ")), props.actions.map(actionLog => {
    return /*#__PURE__*/_react.default.createElement("div", {
...
function Notice(props) {
  ...
  }, __('Undo', 'tooto-pro')))), props.model.dismissible && /*#__PURE__*/_react.default.createElement("button", {
    type: "button",
    className: "notice-dismiss",
    onClick: props.dismiss
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "screen-reader-text"
  }, __('Dismiss this notice.', 'tooto-pro'))));
}
Notice.propTypes = {
...
function Pagination(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, props.total, " ", __('items', 'tooto-pro')), 1 < props.lastPage && /*#__PURE__*/_react.default.createElement("span", {
    ...
    className: "screen-reader-text"
  }, __('Current Page', 'tooto-pro')), /*#__PURE__*/_react.default.createElement("span", {
    className: "paging-input",
    style: {
      margin: '0 6px'
    }
  ...
  }, props.currentPage, " ", __('of', 'tooto-pro'), /*#__PURE__*/_react.default.createElement("span", {
...
function renderSelect2(el, onChange) {
  jQuery(el).select2({
    allowClear: true,
    placeholder: __('All Pages', 'tooto-pro'),
...
function RefererFilter(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("label", {
    ...
    className: "screen-reader-text"
  }, __('Filter by Page', 'tooto-pro')), /*#__PURE__*/_react.default.createElement("select", {
    ref: ref,
...
function SearchBox(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("p", {
    ...
    value: localValue,
    onChange: onChange,
    placeholder: __('Search...', 'tooto-pro')
  }));
}
SearchBox.propTypes = {
  value: PropTypes.string,
...
function SubmissionRow(props) {
  ...
  const mainValue = ((_props$item = props.item) === null || _props$item === void 0 ? void 0 : (_props$item$main = _props$item.main) === null || _props$item$main === void 0 ? void 0 : _props$item$main.value) || __('Unknown', 'tooto-pro');
  return /*#__PURE__*/_react.default.createElement(_wpTable.default.Row, {
    ...
    className: "screen-reader-text"
  }, __('Show more details', 'tooto-pro')))), /*#__PURE__*/_react.default.createElement(_wpTable.default.Cell, {
    ...
    title: `${props.item.actions_succeeded_count}/${props.item.actions_count} ${__('Succeed', 'tooto-pro')}`
  })), /*#__PURE__*/_react.default.createElement(_wpTable.default.Cell, {
...
const ZIP_NAME_FORMAT = 'tooto-submissions-export-{DATE}';
const EXPORT_FILE_NAME_FORMAT = 'tooto-submissions-export-{FORM_LABEL}-{DATE}';
...
const generalError = () => __('Something went wrong, please try again later.', 'tooto-pro');
var _default = {
  trashed: {
    success: function () {
      let count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      return (0, _i18n.sprintf)((0, _i18n._n)('%d submission moved to Trash.', '%d submissions moved to Trash.', count, 'tooto-pro'), count);
    },
    error: generalError
  },
  deleted: {
    success: function () {
      let count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      return (0, _i18n.sprintf)((0, _i18n._n)('%d submission permanently deleted.', '%d submissions permanently deleted.', count, 'tooto-pro'), count);
    },
    error: generalError
  },
  updated: {
    success: function () {
      let count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      return (0, _i18n.sprintf)((0, _i18n._n)('Submission has been successfully updated.', '%d submissions have been successfully updated.', count, 'tooto-pro'), count);
    },
    error: generalError
  },
  restored: {
    success: function () {
      let count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      return (0, _i18n.sprintf)((0, _i18n._n)('%d submission restored from Trash.', '%d submissions restored from Trash.', count, 'tooto-pro'), count);
    },
    error: generalError
  },
  markedAsRead: {
  ...
  actionLogs: {
    success: () => __('Action completed successfully.', 'tooto-pro'),
    failed: () => __('Action failed to run, please check your integration.', 'tooto-pro')
  }
};
...
const STATUSES = [{
  value: 'all',
  label: __('All', 'tooto-pro')
}, {
  value: 'unread',
  label: __('Unread', 'tooto-pro')
}, {
  value: 'read',
  label: __('Read', 'tooto-pro')
}, {
  value: 'trash',
  label: __('Trash', 'tooto-pro')
}];
function Index() {
  ...
  const rowActions = useMemo(() => [{
    ...
    key: 'delete',
    label: __('Delete Permanently', 'tooto-pro'),
    onApply: item => deleteItems({
      id: item.id,
      force: 1
    }),
    ...
    key: 'read',
    label: __('Mark as Read', 'tooto-pro'),
    ...
    key: 'unread',
    label: __('Mark as Unread', 'tooto-pro'),
    onApply: item => updateRead({
      id: item.id
    }, false),
    shouldShow: item => 'trash' !== item.status && item.is_read
  ...
  const bulkActions = useMemo(() => {
    return [{
      ...
      label: __('Move to Trash', 'tooto-pro'),
      value: 'trash',
      onApply: () => deleteItems({
        ids: checked
      }),
  ...
  const tableTitles = useMemo(() => ({
    main_meta_id: {
      label: __('Main', 'tooto-pro'),
      className: 'column-primary'
    },
    actions_log_status: {
      label: __('Actions Status', 'tooto-pro'),
      className: 'column-actions'
    },
    form: {
      label: __('Form', 'tooto-pro'),
      className: 'column-form'
    },
    page: {
      label: __('Page', 'tooto-pro'),
      className: 'column-page'
    },
    id: {
      label: __('ID', 'tooto-pro'),
      className: 'column-id'
    },
    created_at: {
      label: __('Submission Date', 'tooto-pro'),
      className: 'column-date'
    }
  }), []);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_searchBox.default, {
    ...
    name: 'form',
    label: __('Filter by form', 'tooto-pro')
    ...
    label: __('Filter by date', 'tooto-pro'),
    name: "date"
    ...
    colSpan: 7
  }, __('No submissions found.', 'tooto-pro'))), data.map(item => {
...
function Item(props) {
  ...
  if (!Object.keys(data).length) {
    if (error) {
      return /*#__PURE__*/_react.default.createElement("p", null, " ", error.message || __('Not Found', 'tooto-pro'), " ");
    }
    return __('Loading...', 'tooto-pro');
  }
  return /*#__PURE__*/_react.default.createElement("div", {
    id: "poststuff"
    ...
    }, /*#__PURE__*/_react.default.createElement("h2", null, __('Submission', 'tooto-pro'), " #", data.id), /*#__PURE__*/_react.default.createElement("button", {
      onClick: e => {
        e.preventDefault();
    ...
    }, isEditMode ? __('Cancel', 'tooto-pro') : __('Edit', 'tooto-pro')))
    ...
    colSpan: "2"
  }, __('No data', 'tooto-pro'))))))), data.form_actions_log && /*#__PURE__*/_react.default.createElement(_formActionsLog.default, {
    actions: data.form_actions_log
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: "postbox-container",
    id: "postbox-container-1"
  }, /*#__PURE__*/_react.default.createElement(_postBox.default, {
    header: /*#__PURE__*/_react.default.createElement("h2", null, __('Additional Info', 'tooto-pro'), " ")
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "submitbox"
  }, /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, __('Form:', 'tooto-pro'), " ", /*#__PURE__*/_react.default.createElement("a", {
    href: data.post.edit_url,
    target: "_blank",
    rel: "noreferrer"
  }, data.form.name, " (#", data.form.element_id, ")")), /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('Page:', 'tooto-pro'), " ", /*#__PURE__*/_react.default.createElement("a", {
    href: data.referer,
    target: "_blank",
    rel: "noreferrer"
    ...
    className: "misc-pub-section"
  }, __('Create Date:', 'tooto-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, (0, _date.formatToLocalDateTime)(data.created_at))), /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('Update Date:', 'tooto-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, (0, _date.formatToLocalDateTime)(data.updated_at))), data.user_name && /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('User Name:', 'tooto-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, data.user_name)), /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('User IP:', 'tooto-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, data.user_ip)), /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('User Agent:', 'tooto-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, data.user_agent))), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, isTrashEnabled ? __('Move to Trash', 'tooto-pro') : __('Delete Permanently', 'tooto-pro'))), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, __('Update', 'tooto-pro'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "clear"
...
const AppWrapper = tootoCommon.config.isDebug ? _react.default.StrictMode : _react.default.Fragment;
