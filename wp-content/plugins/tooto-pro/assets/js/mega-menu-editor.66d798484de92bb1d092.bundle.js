...
"use strict";
(self["webpackChunktooto_pro"] = self["webpackChunktooto_pro"] || []).push([["mega-menu-editor"],{
...
class MegaMenu extends tooto.modules.elements.types.NestedElementBase {
  getType() {
    return 'mega-menu';
  }
}
...
class Module {
  constructor() {
    tooto.elementsManager.registerElementType(new _megaMenu.default());
  }
}
