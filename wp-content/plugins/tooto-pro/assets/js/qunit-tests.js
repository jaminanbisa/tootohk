...
/**
 * This file load tooto core in order to run 'editor' tests, since the 'pro' does not include the editor it self.
...
// import EditorBootstrapCore from 'tooto/tests/qunit/editor/bootstrap';
...
// 	initialize() {
// 		window.tootoProEditorConfig = editorConfig;
// 
// 		// Load tooto-pro.
