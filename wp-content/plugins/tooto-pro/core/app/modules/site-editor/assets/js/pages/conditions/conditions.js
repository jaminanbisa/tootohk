import { Heading, Text } from '@tooto/app-ui';
...
export default function Conditions( props ) {
	...
	if ( ! template ) {
		return <div>{ __( 'Not Found', 'tooto-pro' ) }</div>;
	}
		...
		<section className="e-site-editor-conditions">
			...
			<div className="e-site-editor-conditions__header">
				...
				<Heading variant="h1" tag="h1">
					{ __( 'Where Do You Want to Display Your Template?', 'tooto-pro' ) }
				</Heading>
				<Text variant="p">
					{ __( 'Set the conditions that determine where your template is used throughout your site.', 'tooto-pro' ) }
					<br />
					{ __( 'For example, choose \'Entire Site\' to display the template across your site.', 'tooto-pro' ) }
				</Text>
			</div>
