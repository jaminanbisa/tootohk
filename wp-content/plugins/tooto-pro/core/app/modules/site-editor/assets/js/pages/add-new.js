import { AddNewButton, Heading, Grid, CardOverlay } from '@tooto/app-ui';
import { SiteParts } from '@tooto/site-editor';
import './add-new.scss';
		...
		<section className="e-site-editor__add-new">
			<Grid container direction="column" className="e-site-editor__header">
				...
				<Grid item container justify="space-between" alignItems="start">
					<Heading variant="h1">{ __( 'Start customizing every part of your site', 'tooto-pro' ) }</Heading>
