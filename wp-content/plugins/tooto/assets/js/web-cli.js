...
var BackwardsCompatibility = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(BackwardsCompatibility, [{
    ...
    value: function ensureTab(namespace, tabSlug) {
        ...
        var Component = /*#__PURE__*/function (_ComponentBase) {
          ...
          (0, _createClass2.default)(Component, [{
            ...
            value: function renderTab(tab) {
              tooto.getPanelView().setPage(page).activateTab(tab);
            }
          }]);
          return Component;
      ...
      if (!component.hasTab(tabSlug) && tooto.config.tabs[tabSlug]) {
        component.addTab(tabSlug, {
          title: tooto.config.tabs[tabSlug]
        });
      }
    }
  }]);
...
var _module = _interopRequireDefault(__webpack_require__(/*! tooto-assets-js/modules/imports/module.js */ "../assets/dev/js/modules/imports/module.js"));
...
var Commands = /*#__PURE__*/function (_CommandsBackwardsCom) {
  ...
  (0, _createClass2.default)(Commands, [{
    ...
    value: function beforeRun(command) {
      ...
      window.dispatchEvent(new CustomEvent('tooto/commands/run/before', {
        detail: {
          command: command,
          args: args
        }
    ...
    value: function afterRun(command, args) {
      ...
      window.dispatchEvent(new CustomEvent('tooto/commands/run/after', {
        detail: {
          command: command,
          args: args
        }
...
var Data = /*#__PURE__*/function (_Commands) {
  ...
  function Data() {
    ...
    _this.args = Object.assign(args, {
      namespace: 'tooto',
      version: '1',
      baseEndpointURL: tootoWebCliConfig.urls.rest
    });
...
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "../node_modules/@babel/runtime/helpers/defineProperty.js"));
var _baseStorage = _interopRequireDefault(__webpack_require__(/*! tooto-api/core/data/storages/base-storage */ "../modules/web-cli/assets/js/core/data/storages/base-storage.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
  ...
  (0, _createClass2.default)(HooksBase, [{
    ...
    value: function checkInstance(instance) {
      if (instance.getType() !== this.getType()) {
        throw new Error("invalid instance, please use: 'tooto-api/modules/hook-base.js'. ");
      }
    }
...
var Data = /*#__PURE__*/function (_HooksBase) {
  ...
  (0, _createClass2.default)(Data, [{
    ...
    key: "shouldRun",
    value: function shouldRun(callbacks) {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(Data.prototype), "shouldRun", this).call(this, callbacks) && tooto.documents.getCurrent().history.getActive();
    }
  }, {
    key: "onRun",
    value: function onRun(command, args, event) {
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "../node_modules/@babel/runtime/helpers/classCallCheck.js"));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ "../node_modules/@babel/runtime/helpers/createClass.js"));
var _environment = _interopRequireDefault(__webpack_require__(/*! tooto-api/utils/environment */ "../modules/web-cli/assets/js/utils/environment.js"));
var _console = _interopRequireDefault(__webpack_require__(/*! tooto-api/utils/console */ "../modules/web-cli/assets/js/utils/console.js"));
    ...
    value: function handle(event) {
      ...
      var filteredHandlers = handlers.filter(function (handler) {
        if (handler.exclude && -1 !== handler.exclude.indexOf('input')) {
          ...
          if ($target.is(':input, .tooto-input') || $target.closest('[contenteditable="true"]').length) {
            return false;
          }
        }
      ...
      if (1 < filteredHandlers.length && tootoWebCliConfig.isDebug) {
...
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "../node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _hookBase = _interopRequireDefault(__webpack_require__(/*! tooto-api/modules/hook-base */ "../modules/web-cli/assets/js/modules/hook-base.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
