/*! tooto - v3.9.2 - 21-12-2022 */
"use strict";
(self["webpackChunktooto"] = self["webpackChunktooto"] || []).push([["onboarding"],{

/***/ "../app/assets/js/molecules/tooto-loading.js":
/*!*******************************************************!*\
  !*** ../app/assets/js/molecules/tooto-loading.js ***!
  \*******************************************************/
...
exports["default"] = tootoLoading;
var _react = _interopRequireDefault(__webpack_require__(/*! react */ "react"));
function tootoLoading(props) {
  return /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-loading"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-loader-wrapper"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-loader"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-loader-boxes"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-loader-box"
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-loader-box"
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-loader-box"
...
var _react = _interopRequireWildcard(__webpack_require__(/*! react */ "react"));
var _context = __webpack_require__(/*! ../context/context */ "../app/modules/onboarding/assets/js/context/context.js");
var _popoverDialog = _interopRequireDefault(__webpack_require__(/*! tooto-app/ui/popover-dialog/popover-dialog */ "../app/assets/js/ui/popover-dialog/popover-dialog.js"));
...
function GoProPopover(props) {
  ...
  var alreadyHaveProButtonRef = (0, _react.useCallback)(function (alreadyHaveProButton) {
    ...
    alreadyHaveProButton.addEventListener('click', function (event) {
      ...
      window.open(alreadyHaveProButton.href + '&mode=popup', 'tootoUploadPro', "toolbar=no, menubar=no, width=728, height=531, top=100, left=100");

      // Run the callback for when the upload succeeds.
      tootoCommon.elements.$body.on('tooto/upload-and-install-pro/success', function () {
        updateState({
          hasPro: true,
          proNotice: {
            type: 'success',
  ...
  return /*#__PURE__*/_react.default.createElement(_popoverDialog.default, {
  ...
  }, __('Ready to Get tooto Pro?', 'tooto')), /*#__PURE__*/_react.default.createElement(_checklist.default, null, /*#__PURE__*/_react.default.createElement(_checklistItem.default, null, __('90+ Basic & Pro widgets', 'tooto')), /*#__PURE__*/_react.default.createElement(_checklistItem.default, null, __('300+ Basic & Pro templates', 'tooto')), /*#__PURE__*/_react.default.createElement(_checklistItem.default, null, __('Premium Support', 'tooto'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__go-pro-paragraph"
  }, __('And so much more!', 'tooto')), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__go-pro-paragraph"
    ...
    href: tootoAppConfig.onboarding.urls.uploadPro,
    rel: "opener"
...
var _headerButtons = _interopRequireDefault(__webpack_require__(/*! tooto-app/layout/header-buttons */ "../app/assets/js/layout/header-buttons.js"));
...
function ContextProvider(props) {
  var onboardingConfig = tootoAppConfig.onboarding,
    initialState = {
      // eslint-disable-next-line camelcase
      hasPro: tootoAppConfig.hasPro,
...
function Account() {
  ...
  if (state.isLibraryConnected) {
    pageTexts = {
      ...
      listItems: [__('Set your site\'s theme', 'tooto'), __('Give your site a name & logo', 'tooto'), __('Choose how to start creating', 'tooto')]
    };
  } else {
    pageTexts = {
      firstLine: __('To get the most out of tooto, we’ll connect your account.', 'tooto') + ' ' + __('Then you can:', 'tooto'),
      listItems: [__('Choose from countless professional templates', 'tooto'), __('Manage your site with our handy dashboard', 'tooto'), __('Take part in the community forum, share & grow together', 'tooto')]
    };
  }
  ...
  }, /*#__PURE__*/_react.default.createElement("p", null, __('Already have one?', 'tooto') + ' ', /*#__PURE__*/_react.default.createElement("a", {
  ...
  }, __('Connect your account', 'tooto'))), /*#__PURE__*/_react.default.createElement(_connect.default, {
...
function GoodToGo() {
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    className: "e-onboarding__page-content-section-title"
  }, __('That\'s a wrap! What\'s next?', 'tooto')), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__page-content-section-text"
  }, __('There are two ways to get started with tooto:', 'tooto')), /*#__PURE__*/_react.default.createElement(_grid.default, {
    container: true,
    alignItems: "center",
    justify: "space-between",
...
function HelloTheme() {
  var _useContext = (0, _react.useContext)(_context.OnboardingContext),
    ...
    noticeStateSuccess = {
      type: 'success',
      icon: 'eicon-check-circle-o',
      message: __('Your site’s got Hello theme. High-five!', 'tooto')
    },
    ...
    continueWithHelloThemeText = state.isHelloThemeActivated ? __('Next', 'tooto') : __('Continue with Hello Theme', 'tooto'),
  ...
  var onHelloThemeActivationSuccess = (0, _react.useCallback)(function () {
    ...
    setActionButtonText(__('Next', 'tooto'));
    var stateToUpdate = getStateObjectToUpdate(state, 'steps', pageId, 'completed');
  ...
  var onErrorInstallHelloTheme = function onErrorInstallHelloTheme() {
    ...
    setNoticeState({
      type: 'error',
      icon: 'eicon-warning',
      message: __('There was a problem installing Hello Theme.', 'tooto')
    });
    resetScreenContent();
  };
  var activateHelloTheme = function activateHelloTheme() {
    ...
    setActivateHelloThemeAjaxState({
      data: {
        action: 'tooto_activate_hello_theme'
      }
    });
  };
  ...
  (0, _react.useEffect)(function () {
    ...
    var timeout4 = setTimeout(function () {
      ...
      }, __('Hold on, this can take a minute...', 'tooto'))));
    }, 4000);
    ...
    var timeout30 = setTimeout(function () {
      ...
      setActionButtonText( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("i", {
        ...
        className: "e-onboarding__action-button-text"
      }, __('Okay, now we\'re really close...', 'tooto'))));
    }, 30000);
    ...
    if ('initial' !== activateHelloThemeAjaxState.status) {
      ...
      if ('success' === activateHelloThemeAjaxState.status && (_activateHelloThemeAj = activateHelloThemeAjaxState.response) !== null && _activateHelloThemeAj !== void 0 && _activateHelloThemeAj.helloThemeActivated) {
        ...
        setNoticeState({
          type: 'error',
          icon: 'eicon-warning',
          message: __('There was a problem activating Hello Theme.', 'tooto')
        });
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    image: tootoCommon.config.urls.assets + 'images/app/onboarding/Illustration_Hello.svg',
    title: __('Every site starts with a theme.', 'tooto'),
    actionButton: actionButton,
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("p", null, __('Hello is tooto\'s official blank canvas theme optimized to build your website exactly the way you want.', 'tooto')), /*#__PURE__*/_react.default.createElement("p", null, __('Here\'s why:', 'tooto')), /*#__PURE__*/_react.default.createElement("ul", {
    className: "e-onboarding__feature-list"
  }, /*#__PURE__*/_react.default.createElement("li", null, __('Light-weight and fast loading', 'tooto')), /*#__PURE__*/_react.default.createElement("li", null, __('Great for SEO', 'tooto')), /*#__PURE__*/_react.default.createElement("li", null, __('Already being used by 1M+ web creators', 'tooto')))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__footnote"
  }, '* ' + __('You can switch your theme later on', 'tooto')));
}
...
var _context = __webpack_require__(/*! ../context/context */ "../app/modules/onboarding/assets/js/context/context.js");
var _router = __webpack_require__(/*! @reach/router */ "../node_modules/@reach/router/es/index.js");
var _useAjax3 = _interopRequireDefault(__webpack_require__(/*! tooto-app/hooks/use-ajax */ "../app/assets/js/hooks/use-ajax.js"));
...
function SiteLogo() {
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("span", null, __('Otherwise, you can skip this and add one later.', 'tooto')), file && !showUnfilteredFilesDialog ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    src: file.url,
    alt: __('Potential Site Logo', 'tooto')
...
function SiteName() {
    ...
    if ('initial' !== ajaxState.status) {
      ...
      if ('success' === ajaxState.status && (_ajaxState$response = ajaxState.response) !== null && _ajaxState$response !== void 0 && _ajaxState$response.siteNameUpdated) {
        ...
        setNoticeState({
          type: 'error',
          icon: 'eicon-warning',
          message: __('Sorry, the name wasn\'t saved. Try again, or skip for now.', 'tooto')
        });
      }
    }
  }, [ajaxState.status]);
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    image: tootoCommon.config.urls.assets + 'images/app/onboarding/Illustration_Setup.svg',
    title: __('Now, let\'s give your site a name.', 'tooto'),
    actionButton: actionButton,
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("p", null, __('This is what your site is called on the WP dashboard, and can be changed later from the general settings - it\'s not your website\'s URL.', 'tooto')), /*#__PURE__*/_react.default.createElement("input", {
...
var _context = __webpack_require__(/*! ../context/context */ "../app/modules/onboarding/assets/js/context/context.js");
var _tootoLoading = _interopRequireDefault(__webpack_require__(/*! tooto-app/molecules/tooto-loading */ "../app/assets/js/molecules/tooto-loading.js"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function UploadAndInstallPro() {
  (0, _usePageTitle.default)({
    title: __('Upload and Install tooto Pro', 'tooto')
  });
  var _useContext = (0, _react.useContext)(_context.OnboardingContext),
    state = _useContext.state,
    _useAjax = (0, _useAjax2.default)(),
  ...
  (0, _react.useEffect)(function () {
    if ('initial' !== installProZipAjaxState.status) {
      ...
      setIsLoading(false);
      if ('success' === installProZipAjaxState.status && (_installProZipAjaxSta = installProZipAjaxState.response) !== null && _installProZipAjaxSta !== void 0 && _installProZipAjaxSta.tootoProInstalled) {
        tootoCommon.events.dispatchEvent({
          event: 'pro uploaded',
          version: '',
          details: {
  ...
  if (isLoading) {
    return /*#__PURE__*/_react.default.createElement(_tootoLoading.default, {
      loadingText: __('Uploading', 'tooto')
    });
  }
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, __('Don\'t know where to get the file from?', 'tooto') + ' ', /*#__PURE__*/_react.default.createElement("a", {
    onClick: function onClick() {
      return onProUploadHelpLinkClick();
    },
    href: 'https://my.tooto.com/subscriptions/' + tootoAppConfig.onboarding.utms.downloadPro,
    target: "_blank"
  }, __('Click here', 'tooto')))));
}
...
function Connect(props) {
  ...
  (0, _react.useEffect)(function () {
    jQuery(props.buttonRef.current).tootoConnect({
