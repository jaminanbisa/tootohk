  ...
  (0, _createClass2.default)(Load, [{
    ...
    value: function apply(args) {
      ...
      if (!component.iframe) {
        ...
        component.iframe.className = 'tooto-app-iframe';
...
var Component = /*#__PURE__*/function (_ComponentModalBase) {
  ...
  (0, _createClass2.default)(Component, [{
    ...
    value: function defaultRoutes() {
      ...
      return {
        '': function _(args) {
          args.url = args.url || tootoAppConfig.menu_url;
          $e.run('app/load', args);
...
var AppLoader = /*#__PURE__*/function () {
  function AppLoader() {
    ...
    (0, _defineProperty2.default)(this, "selector", 'a.tooto-app-link, .tooto-app-link .ab-item');
...
window.tootoAppLoader = new AppLoader();
})();
