...
var BetaTesterLayout = /*#__PURE__*/function (_tootoModules$com) {
  (0, _inherits2.default)(BetaTesterLayout, _tootoModules$com);
  ...
  (0, _createClass2.default)(BetaTesterLayout, [{
    ...
    value: function ui() {
      return {
        ...
        dontShowAgain: '.tooto-beta-tester-do-not-show-again'
      };
    }
  }, {
    key: "events",
    ...
    value: function getLogoOptions() {
      return {
        title: __('Sign Up', 'tooto')
      };
    }
  }, {
    key: "initialize",
    value: function initialize() {
      tootoModules.common.views.modal.Layout.prototype.initialize.apply(this, arguments);
      this.showLogo();
      this.showContentView();
      var doNotShowAgain = __('Don\'t Show Again', 'tooto');
      this.modalHeader.currentView.ui.closeModal.after(jQuery('<div>', {
        class: 'tooto-beta-tester-do-not-show-again'
      }).text(doNotShowAgain));
    }
  }, {
    key: "showContentView",
    ...
    value: function onCloseModalClick() {
      tootoCommon.ajax.addRequest('introduction_viewed', {
        data: {
          introductionKey: tootoAdmin.config.beta_tester.beta_tester_signup
        }
      });
    }
  }]);
...
var BetaTesterView = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  function BetaTesterView() {
    ...
    _this.id = 'tooto-beta-tester-dialog-content';
    _this.template = '#tmpl-tooto-beta-tester';
    return _this;
  }
  (0, _createClass2.default)(BetaTesterView, [{
    ...
    value: function ui() {
      return {
        betaForm: '#tooto-beta-tester-form',
        betaEmail: '#tooto-beta-tester-form__email',
        betaButton: '#tooto-beta-tester-form__submit'
      };
    }
  }, {
    key: "events",
    ...
    value: function onBetaFormSubmit(event) {
      ...
      this.ui.betaButton.addClass('tooto-button-state');
      tootoCommon.ajax.addRequest('beta_tester_signup', {
        data: {
      ...
      tootoBetaTester.layout.hideModal();
    }
  }, {
    key: "onRender",
...
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
var BetaTesterModule = /*#__PURE__*/function (_tootoModules$Vie) {
  (0, _inherits2.default)(BetaTesterModule, _tootoModules$Vie);
  ...
  (0, _createClass2.default)(BetaTesterModule, [{
    ...
    value: function showLayout() {
      ...
      if (!always && (!tootoAdmin.config.beta_tester.option_enabled || tootoAdmin.config.beta_tester.signup_dismissed || '#tab-fontawesome4_migration' === location.hash)) {
        return;
      }
...
jQuery(function () {
  window.tootoBetaTester = new BetaTesterModule();
});
})();
