...
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
// TODO: Wrong location used as `tootoModules.ForceMethodImplementation(); should be` `tootoUtils.forceMethodImplementation()`;
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "../node_modules/@babel/runtime/helpers/classCallCheck.js"));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ "../node_modules/@babel/runtime/helpers/createClass.js"));
// Moved from tooto pro: 'assets/dev/js/frontend/utils'
...
var _default = window.tootoModules = {
...
var _default = /*#__PURE__*/function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function className() {
      return 'tooto-templates-modal__header';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-tooto-templates-modal__header';
    }
  }, {
    key: "regions",
    value: function regions() {
      return {
        logoArea: '.tooto-templates-modal__header__logo-area',
        tools: '#tooto-template-library-header-tools',
        menuArea: '.tooto-templates-modal__header__menu-area'
      };
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        closeModal: '.tooto-templates-modal__header__close'
      };
    }
  }, {
    key: "events",
...
var _default = /*#__PURE__*/function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function initModal() {
      var modalOptions = {
        className: 'tooto-templates-modal',
        closeButton: false,
        draggable: false,
        hide: {
      ...
      this.modal = tootoCommon.dialogsManager.createWidget('lightbox', modalOptions);
...
var _default = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "id",
    value: function id() {
      return 'tooto-template-library-loading';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-tooto-template-library-loading';
    }
  }]);
  return _default;
}(Marionette.ItemView);
...
var _default = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-tooto-templates-modal__header__logo';
    }
  }, {
    key: "className",
    value: function className() {
      return 'tooto-templates-modal__header__logo';
    }
  }, {
    key: "events",
    value: function events() {
...
var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "../node_modules/@babel/runtime/helpers/interopRequireDefault.js");
var _modules = _interopRequireDefault(__webpack_require__(/*! tooto-assets-js/modules/modules */ "../assets/dev/js/modules/modules.js"));
...
var _hookBreak = _interopRequireDefault(__webpack_require__(/*! tooto-api/modules/hook-break */ "../modules/web-cli/assets/js/modules/hook-break.js"));
_modules.default.common = {
  get Component() {
    // `tootoCommon` isn't available during it self initialize.
    setTimeout(function () {
      tootoDevTools.deprecation.deprecated('tootoModules.common.Component', '2.9.0', '$e.modules.ComponentBase');
    }, 2000);
  ...
  get ComponentModal() {
    // `tootoCommon` isn't available during it self initialize.
    setTimeout(function () {
      tootoDevTools.deprecation.deprecated('tootoModules.common.ComponentModal', '2.9.0', '$e.modules.ComponentModalBase');
    }, 2000);
  ...
  get HookBreak() {
    // `tootoCommon` isn't available during it self initialize.
    setTimeout(function () {
      tootoDevTools.deprecation.deprecated('tootoModules.common.HookBreak', '2.9.0', '$e.modules.HookBreak');
    }, 2000);
