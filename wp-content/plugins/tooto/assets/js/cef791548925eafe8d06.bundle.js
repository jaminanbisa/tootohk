...
"use strict";
(self["webpackChunktooto"] = self["webpackChunktooto"] || []).push([["modules_nested-elements_assets_js_editor_nested-element-types-base_js"],{
...
var NestedElementTypesBase = /*#__PURE__*/function (_tooto$modules$el) {
  (0, _inherits2.default)(NestedElementTypesBase, _tooto$modules$el);
...
}(tooto.modules.elements.types.Base);
...
function AddSectionArea(props) {
  var addAreaElementRef = (0, _react.useRef)(),
    containerHelper = tooto.helpers.container;
  ...
  (0, _react.useEffect)(function () {
    ...
    defaultDroppableOptions.items = '> .tooto-add-section-inner';
    defaultDroppableOptions.hasDraggingOnChildClass = 'tooto-dragging-on-child';
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "tooto-add-section-inner"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "e-view tooto-add-new-section"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-add-section-area-button tooto-add-section-button",
    onClick: function onClick() {
      return props.setIsRenderPresets(true);
    },
    title: __('Add new container', 'tooto'),
    role: "button",
    tabIndex: "0"
  }, /*#__PURE__*/_react.default.createElement("i", {
    className: "eicon-plus"
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-add-section-drag-title"
  }, __('Drag widgets here.', 'tooto')))));
}
...
function SelectPreset(props) {
  var containerHelper = tooto.helpers.container,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    className: "tooto-add-section-close"
  }, /*#__PURE__*/_react.default.createElement("i", {
    onClick: function onClick() {
    ...
    className: "tooto-screen-only"
  }, __('Close', 'tooto'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-view e-con-select-preset"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "e-con-select-preset__title"
  }, __('Select your Structure', 'tooto')), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-con-select-preset__list"
  }, tooto.presetsFactory.getContainerPresets().map(function (preset) {
    return /*#__PURE__*/_react.default.createElement("div", {
      onClick: function onClick() {
      ...
      dangerouslySetInnerHTML: {
        __html: tooto.presetsFactory.generateContainerPreset(preset)
      },
      role: "button",
      tabIndex: "0"
    });
  ...
  (0, _createClass2.default)(View, [{
    ...
    value: function events() {
      ...
      events.click = function (e) {
        var closest = e.target.closest('.tooto-element');
        ...
        if (['container', 'widget'].includes(closest === null || closest === void 0 ? void 0 : closest.dataset.element_type)) {
          ...
          var container = tooto.getContainer(closest.dataset.id);
