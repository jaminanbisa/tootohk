...
var NewTemplateView = __webpack_require__(/*! tooto-admin/new-template/view */ "../assets/dev/js/admin/new-template/view.js");
module.exports = tootoModules.common.views.modal.Layout.extend({
  getModalOptions: function getModalOptions() {
    return {
      id: 'tooto-new-template-modal'
    };
  },
  getLogoOptions: function getLogoOptions() {
    return {
      title: __('New Template', 'tooto')
    };
  },
  initialize: function initialize() {
    tootoModules.common.views.modal.Layout.prototype.initialize.apply(this, arguments);
    var lookupControlIdPrefix = 'tooto-new-template__form__';
    ...
    var dynamicControlsVisibilityListener = function dynamicControlsVisibilityListener() {
      tootoAdmin.templateControls.setDynamicControlsVisibility(lookupControlIdPrefix, tooto_new_template_form_controls);
    };
...
module.exports = Marionette.ItemView.extend({
  id: 'tooto-new-template-dialog-content',
  template: '#tmpl-tooto-new-template',
  ui: {},
  events: {},
...
var NewTemplateLayout = __webpack_require__(/*! tooto-admin/new-template/layout */ "../assets/dev/js/admin/new-template/layout.js");
var NewTemplateModule = tootoModules.ViewModule.extend({
  getDefaultSettings: function getDefaultSettings() {
    return {
      selectors: {
        addButton: '.page-title-action:first, #tooto-template-library-add-new'
      }
    };
  },
  ...
  bindEvents: function bindEvents() {
    ...
    tootoCommon.elements.$window.on('hashchange', this.showModalByHash.bind(this));
  },
...
jQuery(function () {
  window.tootoNewTemplate = new NewTemplateModule();
});
})();
