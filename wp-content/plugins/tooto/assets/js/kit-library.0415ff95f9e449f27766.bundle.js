...
(self["webpackChunktooto"] = self["webpackChunktooto"] || []).push([["kit-library"],{
...
function App() {
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    value: tootoAppConfig['kit-library']
    ...
    path: "/overview/:id"
  })))), tootoCommon.config.istootoDebug && /*#__PURE__*/_react.default.createElement(_devtools.ReactQueryDevtools, {
    initialIsOpen: false
  })));
}
...
function ApplyKitDialog(props) {
  ...
  , {
    ...
    text: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, __('You can use everything in this kit, or Customize to only include some items.', 'tooto'), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement("br", null), __('By applying the entire kit, you\'ll override any styles, settings or content already on your site.', 'tooto')),
  ...
  useEffect(function () {
    jQuery(approveButtonRef.current).tootoConnect({
      ...
      error: function error() {
        return props.onError(__('Unable to connect', 'tooto'));
      },
...
function EnvatoPromotion(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    ...
    variant: "xl"
  }, __('Looking for more Kits?', 'tooto'), " ", ' ', /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    variant: "underlined",
    color: "link",
...
function ErrorScreen(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Grid, {
    ...
    src: "".concat(tootoAppConfig.assets_url, "images/no-search-results.svg")
...
function FavoritesActions(props) {
  ...
  return props.isFavorite ? /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    text: __('Remove from Favorites', 'tooto'),
    hideText: true,
    icon: "eicon-heart",
    ...
    text: __('Add to Favorites', 'tooto'),
    hideText: true,
    icon: "eicon-heart-o",
  ...
  return (0, _react.useMemo)(function () {
    ...
    if (type === _useKitCallToAction3.TYPE_PROMOTION && subscriptionPlan) {
      return {
        ...
        text: __('Go %s', 'tooto').replace('%s', subscriptionPlan.label),
        hideText: false,
        variant: 'contained',
        color: 'cta',
        size: 'sm',
...
function ItemHeader(props) {
  ...
  var _useDownloadLinkMutat = (0, _useDownloadLinkMutation.default)(props.model, {
      ...
      onError: function onError(errorResponse) {
        if (401 === errorResponse.code) {
          tootoCommon.config.library_connect.is_connected = false;
          tootoCommon.config.library_connect.current_access_level = 0;
          updateSettings({
        ...
        setError({
          ...
          message: __('Something went wrong.', 'tooto')
        });
      }
    }),
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, error && /*#__PURE__*/_react.default.createElement(_appUi.Dialog, {
    ...
    approveButtonUrl: "http://go.tooto.com/app-kit-library-error/",
    approveButtonOnClick: function approveButtonOnClick() {
      return setError(false);
    },
    dismissButtonText: __('Got it', 'tooto'),
    dismissButtonOnClick: function dismissButtonOnClick() {
      return setError(false);
    },
    onClose: function onClose() {
    ...
    onSuccess: function onSuccess(data) {
      ...
      tootoCommon.config.library_connect.current_access_level = accessLevel;
      updateSettings({
...
var KitListItem = function KitListItem(props) {
  ...
  }, !tootoAppConfig.hasPro && (subscriptionPlan === null || subscriptionPlan === void 0 ? void 0 : subscriptionPlan.label) && /*#__PURE__*/_react.default.createElement(_badge.default, {
    variant: "sm",
...
function Header(props) {
  ...
  }, __('Kit Library', 'tooto'))), props.centerColumn || /*#__PURE__*/_react.default.createElement("span", null), props.endColumn || /*#__PURE__*/_react.default.createElement("div", {
    style: {
      flex: 1
    }
...
function SortSelect(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    text: 'asc' === props.value.direction ? __('Sort Descending', 'tooto') : __('Sort Ascending', 'tooto'),
    hideText: true,
...
var TaxonomiesFilterList = function TaxonomiesFilterList(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_collapse.default, {
    ...
    ,
    placeholder: (0, _i18n.sprintf)(__('Search %s...', 'tooto'), props.taxonomiesByType.label),
    value: search,
  ...
  }, 0 === taxonomies.length && /*#__PURE__*/_react.default.createElement(_appUi.Text, null, __('No Results Found', 'tooto')), taxonomies.map(function (taxonomy) {
...
function fetchContentTypes() {
  return Promise.resolve([{
    id: 'page',
    label: __('Pages', 'tooto'),
    doc_types: ['wp-page'],
    order: 0
  }, {
    id: 'site-parts',
    label: __('Site Parts', 'tooto'),
...
function Favorites(props) {
  ...
  , {
    title: __('No favorites here yet...', 'tooto'),
    description: __('Use the heart icon to save kits that inspire you. You\'ll be able to find them here.', 'tooto'),
    button: {
      text: __('Continue browsing.', 'tooto'),
...
function IndexHeader(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_header.default, {
  ...
  }, __('Import Kit', 'tooto')), /*#__PURE__*/_react.default.createElement(_appUi.ModalProvider, {
    title: __('Welcome to the Library', 'tooto'),
    ...
    tag: "h3",
    variant: "h3"
  }, __('What\'s a Website Kit?', 'tooto')), /*#__PURE__*/_react.default.createElement(_appUi.Text, null, __('A Website Kit is full, ready-made design that you can apply to your site. It includes all the pages, parts, settings and content that you\'d expect in a fully functional website.', 'tooto'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-kit-library-header-info-modal-container"
  }, /*#__PURE__*/_react.default.createElement(_appUi.Heading, {
    tag: "h3",
    variant: "h3"
  }, __('What\'s going on in the Kit Library?', 'tooto')), /*#__PURE__*/_react.default.createElement(_appUi.Text, null, __('Search & filter for kits by category and tags, or browse through individual kits to see what\'s inside.', 'tooto'), /*#__PURE__*/_react.default.createElement("br", null), __('Once you\'ve picked a winner, apply it to your site!', 'tooto'))), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_appUi.Heading, {
    tag: "h3",
    variant: "h3"
  }, __('Happy browsing!', 'tooto')), /*#__PURE__*/_react.default.createElement(_appUi.Text, null, /*#__PURE__*/_react.default.createElement(_appUi.Button, {
...
function useMenuItems(path) {
  return (0, _react.useMemo)(function () {
    ...
    return [{
      label: __('All Website Kits', 'tooto'),
      icon: 'eicon-filter',
      isActive: !page,
      url: '/kit-library',
      trackEventData: {
...
function Index(props) {
  ...
  // eslint-disable-next-line @wordpress/i18n-ellipsis
  , {
    placeholder: __('Search all Website Kits...', 'tooto'),
    ...
    options: [{
      ...
      label: __('Popular', 'tooto'),
      value: 'popularityIndex',
      defaultOrder: 'desc'
    }, {
      label: __('Trending', 'tooto'),
      value: 'trendIndex',
      defaultOrder: 'desc'
    }],
    ...
    description: __('Nothing to worry about, use 🔄 on the top right to try again. If the problem continues, head over to the Help Center.', 'tooto'),
    button: {
      text: __('Learn More', 'tooto'),
      url: 'http://go.tooto.com/app-kit-library-error/',
      target: '_blank'
    }
    ...
    defaultComponent: /*#__PURE__*/_react.default.createElement(_errorScreen.default, {
      title: __('No results matched your search.', 'tooto'),
      description: __('Try different keywords or ', 'tooto'),
      button: {
        text: __('Continue browsing.', 'tooto'),
...
var _react = _interopRequireWildcard(__webpack_require__(/*! react */ "react"));
var _content = _interopRequireDefault(__webpack_require__(/*! tooto-app/layout/content */ "../app/assets/js/layout/content.js"));
...
function Overview(props) {
  ...
  (0, _usePageTitle.default)({
    title: kit ? "".concat(__('Kit Library', 'tooto'), " | ").concat(kit.title) // eslint-disable-next-line @wordpress/i18n-ellipsis
    : __('Loading...', 'tooto')
  });
  if (isError) {
  ...
  if (isLoading) {
    return /*#__PURE__*/_react.default.createElement(_tootoLoading.default, null);
  }
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
...
function Preview(props) {
  ...
  (0, _usePageTitle.default)({
    title: data ? "".concat(__('Kit Library', 'tooto'), " | ").concat(data.title) // eslint-disable-next-line @wordpress/i18n-ellipsis
    : __('Loading...', 'tooto')
  });
  if (isError) {
    // Will be caught by the App error boundary.
...
var NewPageKitListItem = function NewPageKitListItem() {
  return /*#__PURE__*/_react.default.createElement(_appUi.Card, {
    ...
    variant: "h5",
    className: "eps-card__headline"
  }, __('Blank Canvas', 'tooto'))), /*#__PURE__*/_react.default.createElement(_appUi.CardBody, null, /*#__PURE__*/_react.default.createElement(_appUi.CardImage, {
    alt: __('Blank Canvas', 'tooto'),
    src: tootoCommon.config.urls.assets + 'images/app/onboarding/Blank_Preview.jpg' || 0
