...
var NotesAddPanelMenuItem = /*#__PURE__*/function (_$e$modules$hookUI$Af) {
  ...
  (0, _createClass2.default)(NotesAddPanelMenuItem, [{
    ...
    value: function apply() {
      tooto.modules.layouts.panel.pages.menu.Menu.addItem({
        name: 'notes',
        icon: 'eicon-commenting-o',
        title: __('Notes', 'tooto') + '<i class="tooto-panel-menu-item-title-badge eicon-pro-icon"></i>',
        callback: function callback() {
          var hasProAndNotConnected = tooto.helpers.hasProAndNotConnected();
          tooto.promotion.showDialog({
            title: __('Notes', 'tooto'),
            content: __('With Notes, teamwork gets even better. Stay in sync with comments, feedback & more on your website.', 'tooto'),
            position: {
              blockStart: '-3',
              inlineStart: '+10'
            },
            ...
            actionButton: {
              url: hasProAndNotConnected ? tootoProEditorConfig.urls.connect : 'https://go.tooto.com/go-pro-notes/',
              text: hasProAndNotConnected ? __('Connect & Activate', 'tooto') : __('Upgrade', 'tooto')
            }
          });
        }
...
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
var NotesContextMenu = /*#__PURE__*/function (_tootoModules$edi) {
  (0, _inherits2.default)(NotesContextMenu, _tootoModules$edi);
  ...
  (0, _createClass2.default)(NotesContextMenu, [{
    ...
    value: function contextMenuNotesGroup() {
      ...
      elTypes.forEach(function (type) {
        tooto.hooks.addFilter("elements/".concat(type, "/contextMenuGroups"), _this.contextMenuAddGroup);
      });
    }
