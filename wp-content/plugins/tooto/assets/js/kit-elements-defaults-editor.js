            ...
            switch (_context.prev = _context.next) {
              ...
              case 6:
                tooto.notifications.showToast({
                  message: __('Default settings changed.', 'tooto'),
                  buttons: [{
                    name: 'undo',
                    text: __('Undo', 'tooto'),
              ...
              case 9:
                ...
                tooto.notifications.showToast({
                  message: __('An error occurred.', 'tooto')
                });
                throw _context.t0;
              case 13:
                _context.prev = 13;
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                tooto.notifications.showToast({
                  message: __('Default settings has been reset.', 'tooto')
                });
                _context.next = 12;
                break;
              case 8:
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                tooto.notifications.showToast({
                  message: __('Previous settings restored.', 'tooto')
                });
                _context.next = 12;
                break;
              case 8:
...
function getConfirmCreationDialog(_ref) {
  ...
  if (!introductionManager) {
    var _tooto$config$use;
    exports.introductionManager = introductionManager = createIntroductionManager();
    introductionManager.introductionViewed = !!((_tooto$config$use = tooto.config.user.introduction) !== null && _tooto$config$use !== void 0 && _tooto$config$use[introductionKey]);
  }
...
function createIntroductionManager() {
  ...
  var introduction = new tootoModules.editor.utils.Introduction({
    introductionKey: introductionKey,
    dialogType: 'confirm',
    dialogOptions: {
      id: dialogId,
      headerMessage: __('Sure you want to change default settings?', 'tooto'),
      // Translators: %1$s: Opening strong tag, %2$s: Closing strong tag.
      message: __('Your changes will automatically be saved for future uses of this element. %1$sNote:%2$s This includes sensitive information like emails, API keys, etc.', 'tooto').replace('%1$s', '<strong>').replace('%2$s', '</strong>'),
      effects: {
        show: 'fadeIn',
        hide: 'fadeOut'
      },
...
function createCheckboxAndLabel(dialogId) {
  ...
  label.textContent = __('Do not show this message again', 'tooto');
...
var Module = /*#__PURE__*/function (_tootoModules$edi) {
  (0, _inherits2.default)(Module, _tootoModules$edi);
  ...
  (0, _createClass2.default)(Module, [{
    key: "ontootoInit",
    value: function ontootoInit() {
      (0, _api.loadElementsDefaults)();
      _classPrivateMethodGet(this, _addContextMenuItem, _addContextMenuItem2).call(this);
    }
  }, {
    key: "ontootoInitComponents",
    value: function ontootoInitComponents() {
      window.$e.components.register(new _component.default());
    }
  }]);
  return Module;
}(tootoModules.editor.utils.Module);
exports["default"] = Module;
function _addContextMenuItem2() {
  var _tooto$config, _tooto$config$use;
  if (!((_tooto$config = tooto.config) !== null && _tooto$config !== void 0 && (_tooto$config$use = _tooto$config.user) !== null && _tooto$config$use !== void 0 && _tooto$config$use.is_administrator)) {
    return;
  }
  ['widget', 'container', 'section'].forEach(function (elType) {
    tooto.hooks.addFilter("elements/".concat(elType, "/contextMenuGroups"), function (groups, view) {
      var _view$options;
      ...
      return groups.map(function (group) {
        ...
        group.actions = [].concat((0, _toConsumableArray2.default)(group.actions), [{
          ...
          title: __('Save as default', 'tooto'),
          callback: function callback() {
