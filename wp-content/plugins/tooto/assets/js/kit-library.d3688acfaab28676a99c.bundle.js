...
function ConnectDialog(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Dialog, {
    ...
    text: __('Access this template and our entire library by creating an account', 'tooto'),
...
/***/ "../core/app/modules/kit-library/assets/js/components/tooto-loading.js":
/*!*********************************************************************************!*\
  !*** ../core/app/modules/kit-library/assets/js/components/tooto-loading.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
function IndexHeader(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_header.default, {
    ...
    tag: "h3",
    variant: "h3"
  }, __('What\'s a kit?', 'tooto')), /*#__PURE__*/_react.default.createElement(_appUi.Text, null, __('A Template Kit is full, ready-made design that you can apply to your site. It includes all the pages, parts, settings and content that you\'d expect in a fully functional website.', 'tooto'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-kit-library-header-info-modal-container"
  }, /*#__PURE__*/_react.default.createElement(_appUi.Heading, {
    tag: "h3",
    variant: "h3"
...
var _usePageTitle = _interopRequireDefault(__webpack_require__(/*! tooto-app/hooks/use-page-title */ "../core/app/assets/js/hooks/use-page-title.js"));
...
function useMenuItems(path) {
  return (0, _react.useMemo)(function () {
    ...
    return [{
      label: __('All Template Kits', 'tooto'),
      icon: 'eicon-filter',
      isActive: !page,
      url: '/kit-library'
    }, {
...
function Index(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    placeholder: __('Search all Template Kits...', 'tooto'),
...
var _content = _interopRequireDefault(__webpack_require__(/*! tooto/core/app/assets/js/layout/content */ "../core/app/assets/js/layout/content.js"));

var _tootoLoading = _interopRequireDefault(__webpack_require__(/*! ../../components/tooto-loading */ "../core/app/modules/kit-library/assets/js/components/tooto-loading.js"));
...
function Overview(props) {
  ...
  (0, _usePageTitle.default)({
    title: kit ? "".concat(__('Kit Library', 'tooto'), " | ").concat(kit.title) : __('Loading...', 'tooto')
  });
...
function Preview(props) {
  ...
  (0, _usePageTitle.default)({
    title: data ? "".concat(__('Kit Library', 'tooto'), " | ").concat(data.title) : __('Loading...', 'tooto')
  });
