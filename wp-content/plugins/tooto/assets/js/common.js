...
var InstanceType = /*#__PURE__*/function (_Symbol$hasInstance) {
  ...
  (0, _createClass2.default)(InstanceType, null, [{
    ...
    key: "getInstanceType",
    value: function getInstanceType() {
      tootoModules.ForceMethodImplementation();
    }
  }]);
  return InstanceType;
}(Symbol.hasInstance);
...
module.exports = tootoModules.Module.extend({
  initToast: function initToast() {
    var toast = tootoCommon.dialogsManager.createWidget('buttons', {
      id: 'tooto-toast',
      position: {
        my: 'center bottom',
        at: 'center bottom-10',
        of: '#tooto-panel-content-wrapper',
        autoRefresh: true
      },
      hide: {
        onClick: true,
...
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "../node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _commandData = _interopRequireDefault(__webpack_require__(/*! tooto-api/modules/command-data */ "../modules/web-cli/assets/js/modules/command-data.js"));
var _filesUploadHandler = _interopRequireDefault(__webpack_require__(/*! tooto-editor/utils/files-upload-handler */ "../assets/dev/js/editor/utils/files-upload-handler.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
var Media = /*#__PURE__*/function (_CommandData) {
  ...
  (0, _createClass2.default)(Media, [{
    ...
    value: function applyBeforeCreate(args) {
      ...
      args.query = {
        uploadTypeCaller: 'tooto-wp-media-upload'
      };
      args.data = this.file;
      if ((_args$options = args.options) !== null && _args$options !== void 0 && _args$options.progress) {
        this.toast = tooto.notifications.showToast({
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                throw new Error(__('The file exceeds the maximum upload size for this site.', 'tooto'));
              case 3:
                if (!(!window._wpPluploadSettings.defaults.filters.mime_types[0].extensions.split(',').includes(this.file.name.split('.').pop()) && !tooto.config.filesUpload.unfilteredFiles)) {
                  _context.next = 6;
                  break;
                }
...
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "../node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _componentBase = _interopRequireDefault(__webpack_require__(/*! tooto-api/modules/component-base */ "../modules/web-cli/assets/js/modules/component-base.js"));
...
var Debug = function Debug() {
  ...
  this.sendErrors = function () {
    ...
    jQuery.ajax({
      ...
      data: {
        action: 'tooto_js_log',
        _nonce: tootoCommon.ajax.getSettings('nonce'),
        data: errorStack
      },
      success: function success() {
        errorStack = [];
...
var Helpers = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Helpers, [{
    ...
    value: function softDeprecated(name, version, replacement) {
      tootoDevTools.deprecation.deprecated(name, version, replacement);

      // This is is self is deprecated.
      tootoDevTools.deprecation.deprecated('tootoCommon.helpers.softDeprecated', '3.7.0', 'tootoDevTools.deprecation.deprecated');
    }
  }, {
    key: "hardDeprecated",
    value: function hardDeprecated(name, version, replacement) {
      ...
      // This is is self is deprecated.
      tootoDevTools.deprecation.deprecated('tootoCommon.helpers.hardDeprecated', '3.7.0', 'tootoDevTools.deprecation.deprecated');
    }
  }, {
    ...
    value: function deprecatedMessage(type, name, version, replacement) {
      ...
      // This is is self is deprecated.
      tootoDevTools.deprecation.deprecated('tootoCommon.helpers.deprecatedMessage', '3.7.0', 'tootoDevTools.deprecation.deprecated');
    }
  }, {
    key: "consoleWarn",
    value: function consoleWarn() {
      var _tootoDevTools;
      (_tootoDevTools = tootoDevTools).consoleWarn.apply(_tootoDevTools, arguments);

      // This is is self is deprecated.
      tootoDevTools.deprecation.deprecated('tootoCommon.helpers.consoleWarn', '3.7.0', 'tootoDevTools.consoleWarn');
    }
  }, {
    key: "consoleError",
    value: function consoleError(message) {
      ...
      // This is is self is deprecated.
      tootoDevTools.deprecation.deprecated('tootoCommon.helpers.consoleError', '3.7.0', 'console.error');
    }
  }, {
    key: "deprecatedMethod",
    value: function deprecatedMethod(methodName, version, replacement) {
      tootoDevTools.deprecation.deprecated(methodName, version, replacement);

      // This itself is deprecated.
      tootoDevTools.deprecation.deprecated('tootoCommon.helpers.deprecatedMethod', '2.8.0', 'tootoDevTools.deprecation.deprecated');
    }
  }, {
    key: "cloneObject",
...
var _default = /*#__PURE__*/function (_tootoModules$Mod) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function get(key, options) {
      ...
      var tootoStorage = storage.getItem('tooto');
      if (tootoStorage) {
      ...
      var expiration = tootoStorage.__expiration;
    ...
    value: function set(key, value, options) {
      options = options || {};
      var tootoStorage = this.get(null, options);
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function prepareSend(action, options) {
      ...
      var settings = this.getSettings(),
        ajaxParams = tootoCommon.helpers.cloneObject(settings.ajaxParams);
      options = options || {};
      action = settings.actionPrefix + action;
      jQuery.extend(ajaxParams, options);
      var requestConstants = tootoCommon.helpers.cloneObject(this.requestConstants);
...
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
var _default = /*#__PURE__*/function (_tootoModules$Vie) {
  (0, _inherits2.default)(_default, _tootoModules$Vie);
  var _super = _createSuper(_default);
  function _default() {
    (0, _classCallCheck2.default)(this, _default);
    return _super.apply(this, arguments);
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function addPopupPlugin() {
      var counter = 0;
      jQuery.fn.tootoConnect = function (options) {
        var _this = this;
        ...
        if (options !== null && options !== void 0 && options.popup) {
          jQuery(this).on('click', function (event) {
            ...
            window.open(jQuery(_this).attr('href') + '&mode=popup', 'tootoConnect', "toolbar=no, menubar=no, width=".concat(width, ", height=").concat(height, ", top=200, left=0"));
          });
        ...
        var settings = jQuery.extend({
          ...
          error: function error() {
            tooto.notifications.showToast({
              message: __('Unable to connect', 'tooto')
            });
          },
        ...
        this.each(function () {
          ...
          tootoCommon.elements.$window.on('tooto/connect/success/' + callbackId, settings.success).on('tooto/connect/error/' + callbackId, settings.error);
        });
        return this;
      };
    }
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          connectButton: '#tooto-template-library-connect__button'
        }
      };
    }
  }, {
    ...
    value: function applyPopup() {
      this.elements.$connectButton.tootoConnect();
    }
  }, {
    key: "onInit",
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "../node_modules/@babel/runtime/helpers/classCallCheck.js"));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ "../node_modules/@babel/runtime/helpers/createClass.js"));
var _time = _interopRequireDefault(__webpack_require__(/*! tooto-utils/time */ "../assets/dev/js/utils/time.js"));
...
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "../node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _commandBase = _interopRequireDefault(__webpack_require__(/*! tooto-api/modules/command-base */ "../modules/web-cli/assets/js/modules/command-base.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "../node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _componentModalBase = _interopRequireDefault(__webpack_require__(/*! tooto-api/modules/component-modal-base */ "../modules/web-cli/assets/js/modules/component-modal-base.js"));
    ...
    value: function defaultCommands() {
      ...
      return _objectSpread(_objectSpread({
        'navigate/down': function navigateDown() {
          tootoDevTools.deprecation.deprecated("$e.run( 'finder/navigate/down' )", '3.0.0', "$e.run( 'finder/navigate-down' )");
          $e.run('finder/navigate-down');
        },
        'navigate/up': function navigateUp() {
          tootoDevTools.deprecation.deprecated("$e.run( 'finder/navigate/up' )", '3.0.0', "$e.run( 'finder/navigate-up' )");
          $e.run('finder/navigate-up');
        },
        'navigate/select': function navigateSelect(event) {
          tootoDevTools.deprecation.deprecated("$e.run( 'finder/navigate/select', event )", '3.0.0', "$e.run( 'finder/navigate-select', event )");
...
var _default = /*#__PURE__*/function (_tootoModules$Mod) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function onInit() {
      ...
      this.channel = Backbone.Radio.channel('tooto:finder');
...
var _default = /*#__PURE__*/function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "id",
    value: function id() {
      return 'tooto-finder__results-container';
    }
  }, {
    key: "ui",
    value: function ui() {
      this.selectors = {
        noResults: '#tooto-finder__no-results',
        categoryItem: '.tooto-finder__results__item'
      };
    ...
    value: function getTemplate() {
      return '#tmpl-tooto-finder-results-container';
    }
  }, {
    key: "getChildView",
    ...
    value: function initialize() {
      ...
      this.childViewContainer = '#tooto-finder__results';
      this.collection = new Backbone.Collection(Object.values(tootoCommon.finder.getSettings('data')));
    }
  }, {
    key: "activateItem",
    value: function activateItem($item) {
      if (this.$activeItem) {
        this.$activeItem.removeClass('tooto-active');
      }
      $item.addClass('tooto-active');
...
var _default = /*#__PURE__*/function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function className() {
      return 'tooto-finder__results__category';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-tooto-finder__results__category';
    }
  }, {
    key: "getChildView",
    ...
    key: "initialize",
    value: function initialize() {
      this.childViewContainer = '.tooto-finder__results__category__items';
      this.isVisible = true;
    ...
    value: function getTextFilter() {
      return tootoCommon.finder.channel.request('filter:text').trim().toLowerCase();
    }
  }, {
    key: "toggleElement",
    ...
    value: function onRender() {
      this.listenTo(tootoCommon.finder.channel, 'filter:change', this.onFilterChange.bind(this));
    }
  }, {
    key: "onFilterChange",
...
var _default = /*#__PURE__*/function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-tooto-finder';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        searchInput: '#tooto-finder__search__input'
      };
    }
  }, {
    key: "events",
    ...
    value: function onSearchInputInput() {
      ...
      if (value) {
        tootoCommon.finder.channel.reply('filter:text', value).trigger('filter:change');
...
var _default = /*#__PURE__*/function (_Category) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "className",
    value: function className() {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(_default.prototype), "className", this).call(this) + ' tooto-finder__results__category--dynamic';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        title: '.tooto-finder__results__category__title'
      };
    }
  }, {
    key: "fetchData",
    value: function fetchData() {
      ...
      tootoCommon.ajax.addRequest('finder_get_category_items', {
        data: {
...
var _default = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "className",
    value: function className() {
      return 'tooto-finder__results__item';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-tooto-finder__results__item';
    }
  }, {
    key: "events",
    value: function events() {
...
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
var _default = /*#__PURE__*/function (_tootoModules$com) {
  (0, _inherits2.default)(_default, _tootoModules$com);
  var _super = _createSuper(_default);
  function _default() {
    (0, _classCallCheck2.default)(this, _default);
    return _super.apply(this, arguments);
  ...
  return _default;
}(tootoModules.common.views.modal.Layout);
exports["default"] = _default;
...
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "../node_modules/@babel/runtime/helpers/defineProperty.js"));
var _console = _interopRequireDefault(__webpack_require__(/*! tooto-api/utils/console */ "../modules/web-cli/assets/js/utils/console.js"));
...
var _deprecation = _interopRequireDefault(__webpack_require__(/*! tooto-api/utils/deprecation */ "../modules/web-cli/assets/js/utils/deprecation.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
/**
  ...
  (0, _createClass2.default)(CommandBase, [{
    ...
    value: function requireContainer() {
      ...
      containers.forEach(function (container) {
        _this.requireArgumentInstance('container', tootoModules.editor.Container, {
          container: container
        });
      });
    }
...
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "../node_modules/@babel/runtime/helpers/defineProperty.js"));
var _argsObject = _interopRequireDefault(__webpack_require__(/*! tooto-assets-js/modules/imports/args-object */ "../assets/dev/js/modules/imports/args-object.js"));
var _deprecation = _interopRequireDefault(__webpack_require__(/*! tooto-api/utils/deprecation */ "../modules/web-cli/assets/js/utils/deprecation.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
/**
...
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "../node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _commandCallbackBase = _interopRequireDefault(__webpack_require__(/*! tooto-api/modules/command-callback-base */ "../modules/web-cli/assets/js/modules/command-callback-base.js"));
var _toolkit = __webpack_require__(/*! @reduxjs/toolkit */ "../node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
var _module = _interopRequireDefault(__webpack_require__(/*! tooto/assets/dev/js/modules/imports/module.js */ "../assets/dev/js/modules/imports/module.js"));
var _forceMethodImplementation = _interopRequireDefault(__webpack_require__(/*! ../utils/force-method-implementation */ "../modules/web-cli/assets/js/utils/force-method-implementation.js"));
var _deprecation = _interopRequireDefault(__webpack_require__(/*! tooto-api/utils/deprecation */ "../modules/web-cli/assets/js/utils/deprecation.js"));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
var ComponentBase = /*#__PURE__*/function (_Module) {
  ...
  (0, _createClass2.default)(ComponentBase, [{
    ...
    value: function activateTab(tab, args) {
      ...
      jQuery(this.getTabsWrapperSelector() + ' .tooto-component-tab').off('click').on('click', function (event) {
        $e.route(_this4.getTabRoute(event.currentTarget.dataset.tab), args);
      }).removeClass('tooto-active').filter('[data-tab="' + tab + '"]').addClass('tooto-active');
    }
  }, {
...
var Console = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Console, null, [{
    ...
    value: function warn() {
      var _console;
      var style = "font-size: 12px; background-image: url(\"".concat(tootoWebCliConfig.urls.assets, "images/logo-icon.png\"); background-repeat: no-repeat; background-size: contain;");
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
...
var Deprecation = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Deprecation, null, [{
    ...
    value: function isSoftDeprecated(version) {
      var total = this.compareVersion(version, tootoWebCliConfig.version);
      return total <= 4;
    }
...
var _ajax = _interopRequireDefault(__webpack_require__(/*! tooto-common-modules/ajax/assets/js/ajax */ "../core/common/modules/ajax/assets/js/ajax.js"));
var _finder = _interopRequireDefault(__webpack_require__(/*! tooto-common-modules/finder/assets/js/finder */ "../core/common/modules/finder/assets/js/finder.js"));
var _connect = _interopRequireDefault(__webpack_require__(/*! tooto-common-modules/connect/assets/js/connect */ "../core/common/modules/connect/assets/js/connect.js"));
...
var _component2 = _interopRequireDefault(__webpack_require__(/*! tooto-common-modules/event-tracker/assets/js/data/component */ "../core/common/modules/event-tracker/assets/js/data/component.js"));
var _events = _interopRequireDefault(__webpack_require__(/*! tooto-common-modules/event-tracker/assets/js/events */ "../core/common/modules/event-tracker/assets/js/events.js"));
var _notifications = _interopRequireDefault(__webpack_require__(/*! tooto-utils/notifications */ "../assets/dev/js/utils/notifications.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
var tootoCommonApp = /*#__PURE__*/function (_tootoModules$Vie) {
  (0, _inherits2.default)(tootoCommonApp, _tootoModules$Vie);
  var _super = _createSuper(tootoCommonApp);
  function tootoCommonApp() {
    (0, _classCallCheck2.default)(this, tootoCommonApp);
    return _super.apply(this, arguments);
  }
  (0, _createClass2.default)(tootoCommonApp, [{
    ...
    value: function initComponents() {
      ...
      tootoCommon.elements.$window.on('tooto:init-components', function () {
        $e.components.register(new _component.default());
      });
      this.initModules();
    }
    ...
    key: "onInit",
    value: function onInit() {
      (0, _get2.default)((0, _getPrototypeOf2.default)(tootoCommonApp.prototype), "onInit", this).call(this);
      this.config = tootoCommonConfig;
      this.setMarionetteTemplateCompiler();
    }
  }]);
  return tootoCommonApp;
}(tootoModules.ViewModule);
window.tootoCommon = new tootoCommonApp();
tootoCommon.initComponents();
})();
