...
/* global tootoAdminBarConfig */
var AdminBar = /*#__PURE__*/function (_tootoModules$Vie) {
  (0, _inherits2.default)(AdminBar, _tootoModules$Vie);
  ...
  (0, _createClass2.default)(AdminBar, [{
    ...
    function getDefaultSettings() {
      return {
        ...
        classes: {
          ...
          adminBarItemTitle: 'tooto-edit-link-title',
          adminBarItemSubTitle: 'tooto-edit-link-type',
    ...
    value: function onInit() {
      ...
      this.createMenu(tootoAdminBarConfig);
    }
    ...
    value: function createMenuItem(item) {
      ...
      return jQuery('<li>', {
        id: id,
        class: children.length ? 'menupop' : '' + (item.parent_class || 'tooto-general-section')
...
/******/ })()
;
//# sourceMappingURL=tooto-admin-bar.js.map