...
function AdminTopBar() {
  ...
  var finderTooltipText = __('Search or do anything in tooto', 'tooto') + " ".concat(controlSign, "+E");
  ...
  }, window.tootoAdminTopBarConfig.is_administrator ? /*#__PURE__*/_react.default.createElement(_barButton.default, {
    onClick: finderAction,
    dataInfo: finderTooltipText,
    icon: "eicon-search-bold"
  }, __('Finder', 'tooto')) : '', window.tootoCloudAdmin ? window.tootoCloudAdmin() : ''), /*#__PURE__*/_react.default.createElement(_connectionButton.default, null)));
}
...
function ConnectionButton() {
  ...
  var isUserConnected = tootoAdminTopBarConfig.is_user_connected;
  (0, _react.useEffect)(function () {
  ...
  var tooltipText = __('Connect your account to get access to tooto\'s Template Library & more.', 'tooto'),
    connectUrl = tootoAdminTopBarConfig.connect_url,
    buttonText = __('Connect Account', 'tooto'),
    targetUrl = '_self';
  if (isUserConnected) {
    tooltipText = '';
    connectUrl = 'https://go.tooto.com/wp-dash-admin-bar-account/';
    buttonText = __('My tooto', 'tooto');
    targetUrl = '_blank';
  }
...
var usePageTitle = function usePageTitle() {
  var _useState = (0, _react.useState)('tooto'),
...
var AppWrapper = tootoCommon.config.isDebug ? _react.default.StrictMode : _react.default.Fragment;
var adminTopBarElement = document.getElementById('e-admin-top-bar-root');
var tootoMenuItemIds = ['toplevel_page_tooto', 'menu-posts-tooto_library'];
var menuItemSelector = tootoMenuItemIds.map(function (itemId) {
  return "#".concat(itemId, " .wp-menu-open");
}).join(', ');
var istootoPage = !!document.querySelector(menuItemSelector);
if (istootoPage) {
