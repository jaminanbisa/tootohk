...
var softDeprecated = function softDeprecated(name, version, replacement) {
  if (tootoDevToolsConfig.isDebug) {
...
var deprecatedMessage = function deprecatedMessage(type, name, version, replacement) {
  ...
  tootoDevTools.consoleWarn(message);
};
var Deprecation = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Deprecation, [{
    ...
    value: function isSoftDeprecated(version) {
      var total = this.compareVersion(version, tootoDevToolsConfig.deprecation.current_version);
      return total <= tootoDevToolsConfig.deprecation.soft_version_count;
    }
    ...
    value: function isHardDeprecated(version) {
      var total = this.compareVersion(version, tootoDevToolsConfig.deprecation.current_version);
      return total < 0 || total >= tootoDevToolsConfig.deprecation.hard_version_count;
    }
  }]);
  return Deprecation;
}();
...
var Module = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Module, [{
    ...
    value: function notifyBackendDeprecations() {
      var _this = this;
      var notices = tootoDevToolsConfig.deprecation.soft_notices;
    ...
    value: function consoleWarn() {
      var _console;
      var style = "font-size: 12px; background-image: url(\"".concat(tootoDevToolsConfig.urls.assets, "images/logo-icon.png\"); background-repeat: no-repeat; background-size: contain;");
...
if (!window.tootoDevTools) {
  window.tootoDevTools = new _module.default(new _deprecation.default());
  window.tootoDevTools.notifyBackendDeprecations();
}
})();
