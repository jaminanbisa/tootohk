...
var ConvertAll = /*#__PURE__*/function (_$e$modules$document$) {
  ...
  (0, _createClass2.default)(ConvertAll, [{
    ...
    value: function getHistory() {
      return {
        type: __('Converted to Containers', 'tooto'),
        title: __('All Content', 'tooto')
      };
    }
  }, {
    key: "apply",
    value: function apply() {
      var _tooto$getPreview = tooto.getPreviewContainer(),
        children = _tooto$getPreview.children;
...
var Convert = /*#__PURE__*/function (_$e$modules$document$) {
  ...
  (0, _createClass2.default)(Convert, [{
    ...
    value: function getHistory() {
      return {
        type: __('Converted to Container', 'tooto'),
        title: __('Section', 'tooto')
      };
    }
  }, {
    key: "validateArgs",
...
var _default = /*#__PURE__*/function (_$e$modules$Component) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function bindEvents() {
      tooto.channels.editor.on('tootoContainerConverter:convert', function (_ref) {
        var container = _ref.container,
          el = _ref.el;
        var button = el.querySelector('.tooto-button');
        ...
        setTimeout(function () {
          ...
          tooto.notifications.showToast({
            message: __('Your changes have been updated.', 'tooto')
          });
        });
      });
    }
...
function responsive(key, value) {
  var breakpoints = [''].concat((0, _toConsumableArray2.default)(Object.keys(tootoFrontend.config.responsive.activeBreakpoints)));
