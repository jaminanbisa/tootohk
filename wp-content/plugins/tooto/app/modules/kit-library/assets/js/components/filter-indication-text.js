...
import { Text, Button, Grid } from '@tooto/app-ui';
			...
			<Text className="e-kit-library__filter-indication-text">
				{
					...
					sprintf( _n( 'Showing %s result for', 'Showing %s results for', props.resultCount, 'tooto' ), ! props.resultCount ? __( 'no', 'tooto' ) : props.resultCount ) }
				{ ' ' }
