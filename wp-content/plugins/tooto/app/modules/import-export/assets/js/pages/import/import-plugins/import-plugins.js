		...
		/> } >
			<section className="e-app-import-plugins">
...

				{
					...
					<Notice label={ __( ' Recommended:', 'tooto' ) } className="e-app-import-plugins__versions-notice" color="warning">
						{ __( 'Head over to Updates and make sure that your plugins are updated to the latest version.', 'tooto' ) } <InlineLink url={ tootoAppConfig.admin_url + 'update-core.php' }>{ __( 'Take me there', 'tooto' ) }</InlineLink>
					</Notice>
				}
