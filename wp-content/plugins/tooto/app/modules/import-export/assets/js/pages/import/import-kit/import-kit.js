...
export default function ImportKit() {
	const sharedContext = useContext( SharedContext ),
		...
		getLearnMoreLink = () => (
			<InlineLink url="https://go.tooto.com/app-what-are-kits" key="learn-more-link" italic onClick={ () => eventTracking( 'kit-library/seek-more-info', null, 'click' ) } >
				{ __( 'Learn More', 'tooto' ) }
			</InlineLink>
		);
		...
		<Layout type="import">
			<section className="e-app-import">
				...
				<PageHeader
					...
					description={ [
						__( 'Upload a file with templates, site settings, content, etc., and apply them to your site automatically.', 'tooto' ),
						getLearnMoreLink(),
					] }
				/>

				<Notice label={ __( 'Important:', 'tooto' ) } color="warning" className="e-app-import__notice">
					{ __( 'We recommend that you backup your site before importing a kit file.', 'tooto' ) }
				</Notice>
