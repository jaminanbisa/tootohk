		...
		<Layout type="import" footer={ getFooter() }>
			<section className="e-app-import-content">
				<PageHeader
					...
					description={ [
						__( 'These are the templates, content and site settings that come with your kit.', 'tooto' ),
						__( "All items are already selected by default. Uncheck the ones you don't want.", 'tooto' ),
					] }
				/>
