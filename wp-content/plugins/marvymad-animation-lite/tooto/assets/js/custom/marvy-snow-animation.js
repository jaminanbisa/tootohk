(function ($) {
    ...
    var MarvyColorSnowAnimation = {
        initColorSnow: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', MarvyColorSnowAnimation.initColorSnowWidget);
        },
        initColorSnowWidget: function ($scope) {
            ...
            if (window.isEditMode || window.tootoFrontend.isEditMode()) {
                ...
                colorSnowEditorElements = window.tooto.elements;
    ...
    $(window).on('tooto/frontend/init', MarvyColorSnowAnimation.initColorSnow);
    ...
    function colorSnowAnimation(target, settings, sectionId, sectionKey) {
        ...
        if (checkElement.length <= 0) {
            ...
            var zIndex = document.querySelector('.marvy-custom-snow-section-' + sectionId + ' .tooto-container');
