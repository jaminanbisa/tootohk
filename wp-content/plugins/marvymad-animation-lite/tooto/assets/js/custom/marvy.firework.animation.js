(function ($) {
    ...
    var MarvyFireworkAnimation = {
        initFirework: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', MarvyFireworkAnimation.initFireworkWidget);
        },
        ...
        loadFireworks: function (target, sectionId, settings) {
            ...
            if (checkElement.length >= 0) {
                ...
                const fireworkZindex = document.querySelector('.marvy-custom-firework-animation-section-' + sectionId + ' .tooto-container');
                fireworkZindex.style.zIndex = '99';

                // Set min height
                const fireworkMinHeight = document.querySelector(".tooto-element-" + sectionId);
                fireworkMinHeight.closest('.tooto-top-section').style.minHeight = "100px";
                // Canvas Setup End
    ...
    $(window).on('tooto/frontend/init', MarvyFireworkAnimation.initFirework);
