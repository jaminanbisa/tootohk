(function( $ ) {
    ...
    var VisualGradientBackgroundAnimation = {
        initGradientBackground: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualGradientBackgroundAnimation.initGradientBackgroundWidget);
        },
    ...
    function gradientBackgroundAnimation(target, settings, sectionId, sectionKey) {
        ...
        if (checkElement.length >= 0) {
            ...
            var gradientBackgroundZindex = document.querySelector('.marvy-custom-gradientBackground-animation-section-'+sectionId+' .tooto-container');
    ...
    $( window ).on('tooto/frontend/init', VisualGradientBackgroundAnimation.initGradientBackground);
})( jQuery );
