...
jQuery(document).ready(function ($) {
    ...
    function PP_RecaptionButton(btnName, btnSelector, btnCaption) {
        ...
        if ($(btnSelector).length && btnCaption && (btnCaption != $(btnSelector).html())) {
    ...
    setInterval(
        function() {
            if ($('div.editor-post-publish-panel:visible').length && !initInterval) {
                initInterval = setInterval(PP_InitializeBlockEditorModifications, 100);
            }
