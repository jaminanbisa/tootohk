( function( $ ) {
	...
	$( window ).on( 'tooto/frontend/init', function () {
		...
		tootoFrontend.hooks.addAction( 'frontend/element_ready/pp-business-reviews.default', WidgetPPReviewsHandler );

		tootoFrontend.hooks.addAction( 'frontend/element_ready/pp-business-reviews.classic', WidgetPPReviewsHandler );

		tootoFrontend.hooks.addAction( 'frontend/element_ready/pp-business-reviews.card', WidgetPPReviewsHandler );
