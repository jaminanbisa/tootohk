	...
	PPHeaderLayout = {
		...
		init: function () {
			var isEditMode = false,
				header = $('.pp-tooto-header[data-type=header]');
		...
		_matchDevice: function (breakpoint) {
			...
			var breakpoints = tootoFrontend.config.breakpoints;
		...
		_doShrink: function () {
			...
			if (winTop > headerTop + headerHeight) {
				...
				if (!hasClass) {
					...
					this.header.find('.tooto-section').each(function () {
					...
					this.header.find('.tooto-column-wrap').each(function () {
		...
		_removeShrink: function () {
			var rows = this.header.find('.tooto-section'),
				modules = this.header.find('.tooto-column-wrap');
		...
		_setImageMaxHeight: function () {
			var head = $('head'),
				...
				styles = '',
				images = this.header.find('.tooto-element img');
			...
			images.each(function (i) {
				var image = $(this),
					height = image.height(),
					node = image.closest('.tooto-element').data('id'),
					className = 'tooto-element-' + node + '-img-' + i;
