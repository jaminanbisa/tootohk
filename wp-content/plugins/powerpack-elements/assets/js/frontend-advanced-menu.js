;(function($) {
	...
	PPAdvancedMenu.prototype = {
		...
		bindEvents: function () {
			...
			if ('default' === this.menuType) {
				tootoFrontend.addListenerOnce( this.node.data( 'model-cid' ), 'resize', $.proxy( this.stretchMenu, this ) );
			}
		...
		panelUpdate: function() {
			...
			if ('undefined' !== typeof tooto && $( 'body' ).hasClass( 'tooto-editor-active' )) {
				tooto.hooks.addAction(
		...
		initStretchElement: function () {
			this.stretchElement = new tootoFrontend.modules.StretchElement( { element: this.dropdownMenu } );
		},
	...
	$(window).on('tooto/frontend/init', function () {
		...
		tootoFrontend.hooks.addAction( 'frontend/element_ready/pp-advanced-menu.default', AdvancedMenuHandler );
    });
