(function( $ ) {
    ...
    var VisualNetAnimation = {
        initNet: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualNetAnimation.initNetWidget);
        },
    ...
    function netAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var netZindex = document.querySelector('.marvy-custom-net-animation-section-'+sectionId+' .tooto-container');
            netZindex.style.zIndex = '99';

            // Set min height
            var netMinHeight = document.querySelector(".tooto-element-"+sectionId);
            netMinHeight.closest('.tooto-top-section').style.minHeight = "100px";
    ...
    $( window ).on('tooto/frontend/init', VisualNetAnimation.initNet);
})( jQuery );