(function ($) {
    ...
    var VisualDNAAnimation = {
        initDNA: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualDNAAnimation.initDNAWidget);
        },
    ...
    function dnaAnimation(target, settings, sectionId) {
        ...
        if (checkElement.length >= 0 && settings) {
            ...
            var dnaZindex = document.querySelector('.marvy-custom-dna-animation-section-' + sectionId + ' .tooto-container');
  ...
  `
    ...
    $(window).on('tooto/frontend/init', VisualDNAAnimation.initDNA);
})(jQuery);
