(function( $ ) {
    ...
    var VisualDigitalStreamAnimation = {
        initDigitalStream: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualDigitalStreamAnimation.initDigitalStreamWidget);
        },
    ...
    $( window ).on('tooto/frontend/init', VisualDigitalStreamAnimation.initDigitalStream);
})( jQuery );