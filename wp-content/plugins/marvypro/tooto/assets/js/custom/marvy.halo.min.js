(function( $ ) {
    ...
    var VisualHaloAnimation = {
        initHalo: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualHaloAnimation.initHaloWidget);
        },
    ...
    function haloAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var haloZindex = document.querySelector('.marvy-custom-halo-animation-section-'+sectionId+' .tooto-container');
            haloZindex.style.zIndex = '99';

            // Set min height
            var haloMinHeight = document.querySelector(".tooto-element-"+sectionId);
            haloMinHeight.closest('.tooto-top-section').style.minHeight = "100px";
    ...
    $( window ).on('tooto/frontend/init', VisualHaloAnimation.initHalo);
})( jQuery );