(function( $ ) {
    ...
    var VisualTrunkAnimation = {
        initTrunk: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualTrunkAnimation.initTrunkWidget);
        },
    ...
    function trunkAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var trunkZindex = document.querySelector('.marvy-custom-trunk-animation-section-'+sectionId+' .tooto-container');
            trunkZindex.style.zIndex = '99';

            // Set min height
            var trunkMinHeight = document.querySelector(".tooto-element-"+sectionId);
            trunkMinHeight.closest('.tooto-top-section').style.minHeight = "200px";
    ...
    $( window ).on('tooto/frontend/init', VisualTrunkAnimation.initTrunk);
})( jQuery );