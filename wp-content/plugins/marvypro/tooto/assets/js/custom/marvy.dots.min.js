(function( $ ) {
    ...
    var VisualDotsAnimation = {
        initDots: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualDotsAnimation.initDotsWidget);
        },
    ...
    function dotsAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var dotsZindex = document.querySelector('.marvy-custom-dots-animation-section-'+sectionId+' .tooto-container');
            dotsZindex.style.zIndex = '99';

            // Set min height
            var dotsMinHeight = document.querySelector(".tooto-element-"+sectionId);
            dotsMinHeight.closest('.tooto-top-section').style.minHeight = "200px";
    ...
    $( window ).on('tooto/frontend/init', VisualDotsAnimation.initDots);
})( jQuery );