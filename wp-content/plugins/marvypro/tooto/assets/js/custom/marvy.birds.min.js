(function( $ ) {
    ...
    var VisualBirdsAnimation = {
        initBirds: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualBirdsAnimation.initBirdsWidget);
        },
    ...
    function birdsAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var birdsZindex = document.querySelector('.marvy-custom-birds-animation-section-'+sectionId+' .tooto-container');
    ...
    $( window ).on('tooto/frontend/init', VisualBirdsAnimation.initBirds);
})( jQuery );