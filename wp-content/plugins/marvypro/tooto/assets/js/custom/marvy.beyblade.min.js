(function ($) {
    ...
    var VisualBeyBladeAnimation = {
        initFog: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualBeyBladeAnimation.initBeyBladeWidget);
        },
    ...
    function beyBladeAnimation(target, mainSettings, sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var beybladeZindex = document.querySelector('.marvy-custom-beyblade-animation-section-' + sectionId + ' .tooto-container');
            beybladeZindex.style.zIndex = '99';

            // Set min height
            var beybladeMinHeight = document.querySelector(".tooto-element-" + sectionId);
            beybladeMinHeight.closest('.tooto-top-section').style.minHeight = "100px";
            // Canvas Setup End
    ...
    $(window).on('tooto/frontend/init', VisualBeyBladeAnimation.initFog);
})
(jQuery);