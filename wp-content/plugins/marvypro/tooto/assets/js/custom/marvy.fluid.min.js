(function ($) {
    ...
    var VisualFluidAnimation = {
        initFluid: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualFluidAnimation.initFluidWidget);
        },
    ...
    function fluidAnimation(target, settings, sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var fluidZindex = document.querySelector('.marvy-custom-fluid-animation-section-' + sectionId + ' .tooto-container');
            fluidZindex.style.zIndex = '1';

            var fluidPosition = document.querySelector('.tooto-element-' + sectionId + ' > canvas ');
...
`);
    ...
    $(window).on('tooto/frontend/init', VisualFluidAnimation.initFluid);
})(jQuery);
