(function( $ ) {
    ...
    var VisualFogAnimation = {
        initFog: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualFogAnimation.initFogWidget);
        },
    ...
    function fogAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var fogZindex = document.querySelector('.marvy-custom-fog-animation-section-'+sectionId+' .tooto-container');
            fogZindex.style.zIndex = '99';

            // Set min height
            var fogMinHeight = document.querySelector(".tooto-element-"+sectionId);
            fogMinHeight.closest('.tooto-top-section').style.minHeight = "100px";
    ...
    $( window ).on('tooto/frontend/init', VisualFogAnimation.initFog);
})( jQuery );