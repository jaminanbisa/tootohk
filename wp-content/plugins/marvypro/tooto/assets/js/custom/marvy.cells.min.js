(function( $ ) {
    ...
    var VisualCellsAnimation = {
        initCells: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualCellsAnimation.initCellsWidget);
        },
    ...
    function cellsAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var cellsZindex = document.querySelector('.marvy-custom-cells-animation-section-'+sectionId+' .tooto-container');
    ...
    $( window ).on('tooto/frontend/init', VisualCellsAnimation.initCells);
})( jQuery );