(function ($) {
    ...
    var VisualParticlesWaveAnimation = {
        initParticlesWave: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualParticlesWaveAnimation.initParticlesWaveWidget);
        },
    ...
    function particlesWaveAnimation(target, settings, sectionId) {
        ...
        if (checkElement.length >= 0 && settings) {
            ...
            var particlesWaveZindex = document.querySelector('.marvy-custom-particles-wave-animation-section-' + sectionId + ' .tooto-container');
    ...
    $(window).on('tooto/frontend/init', VisualParticlesWaveAnimation.initParticlesWave);
})(jQuery);
