(function( $ ) {
    ...
    var VisualFloatingHeartAnimation = {
        initFloatingHeart: function () {
            tootoFrontend.hooks.addAction('frontend/element_ready/section', VisualFloatingHeartAnimation.initFloatingHeartWidget);
        },
    ...
    function floatingHeartAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0 && settings) {
            ...
            var flotingHeartZindex = document.querySelector('.marvy-custom-floating-heart-animation-section-'+sectionId+' .tooto-container');
    ...
    $( window ).on('tooto/frontend/init', VisualFloatingHeartAnimation.initFloatingHeart);
})( jQuery );
