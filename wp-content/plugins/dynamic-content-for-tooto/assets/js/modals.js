(function ($) {
  var WidgetElementsPopupHandler = function ($scope, $) {
      ...
      function dce_hide_modal(id_modal) {
		  ...
		  $('.tooto-video').each(function(){
			this.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', '*')
		  });

		  $('.tooto-video-iframe').each(function(){
    ...
    $(window).on('tooto/frontend/init', function () {
        tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-popup.default', WidgetElementsPopupHandler);
    });
})(jQuery);
