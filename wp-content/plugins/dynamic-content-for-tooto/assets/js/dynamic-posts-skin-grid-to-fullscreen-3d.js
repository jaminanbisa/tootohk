...
jQuery(window).on('tooto/frontend/init', function() {
  tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.gridtofullscreen3d', Widget_DCE_Dynamicposts_gridtofullscreen3d_Handler);
  tootoFrontend.hooks.addAction('frontend/element_ready/dce-woo-products-cart.gridtofullscreen3d', Widget_DCE_Dynamicposts_gridtofullscreen3d_Handler);
  tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.gridtofullscreen3d', Widget_DCE_Dynamicposts_gridtofullscreen3d_Handler);
  tootoFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.gridtofullscreen3d', Widget_DCE_Dynamicposts_gridtofullscreen3d_Handler);
  tootoFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.gridtofullscreen3d', Widget_DCE_Dynamicposts_gridtofullscreen3d_Handler);
  tootoFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.gridtofullscreen3d', Widget_DCE_Dynamicposts_gridtofullscreen3d_Handler);
  tootoFrontend.hooks.addAction('frontend/element_ready/dce-search-results.gridtofullscreen3d', Widget_DCE_Dynamicposts_gridtofullscreen3d_Handler);
});
