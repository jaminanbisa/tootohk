...
function checkTimelineScroll(){verticalTimelinesArray.forEach(function(timeline){timeline.showBlocks()});scrolling=!1}};$(window).on('tooto/frontend/init',function(){if(tootoFrontend.isEditMode()){isEditMode=!0}
if($('body').is('.admin-bar')){isAdminBar=!0}
tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-dynamicusers.default',WidgetElementsDynamicUsersDCEHandler)})})(jQuery)