...
self.blocks[i].classList.add("dce-timeline__focus")}else{self.blocks[i].classList.remove("dce-timeline__focus")}})(i)}};$body=$scope.find('.dce-nextpost-wrapper');$window=$(window);$html=$(document.documentElement);initTimeline();var Dyncontel_MutationObserverCallback=function(mutationsList,observer){for(var mutation of mutationsList){if(mutation.type=='attributes'){if(mutation.attributeName==='class'){if(isTimelineEnabled){layoutTimeline()}}}}};observe_Dyncontel_element($scope[0],Dyncontel_MutationObserverCallback)};jQuery(window).on('tooto/frontend/init',function(){tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.timeline',Widget_DCE_Dynamicposts_timeline_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.timeline',Widget_DCE_Dynamicposts_timeline_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.timeline',Widget_DCE_Dynamicposts_timeline_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.timeline',Widget_DCE_Dynamicposts_timeline_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-search-results.timeline',Widget_DCE_Dynamicposts_timeline_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.timeline',Widget_DCE_Dynamicposts_timeline_Handler)})