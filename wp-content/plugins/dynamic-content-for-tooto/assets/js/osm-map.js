jQuery( window ).on( 'tooto/frontend/init', () => {
	class OsmMap extends tootoModules.frontend.handlers.Base {
 		getDefaultSettings() {
 			return {
 				selectors: {
	...
	const addHandler = ( $element ) => {
		tootoFrontend.elementsHandler.addHandler( OsmMap, { $element, } );
	};
	tootoFrontend.hooks.addAction( 'frontend/element_ready/dce-osm-map.default', addHandler );
});
