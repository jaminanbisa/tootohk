...
jQuery(window).on('tooto/frontend/init', function () {
    tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.smoothscroll', Widget_DCE_Dynamicposts_smoothscroll_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.smoothscroll', Widget_DCE_Dynamicposts_smoothscroll_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.smoothscroll', Widget_DCE_Dynamicposts_smoothscroll_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.smoothscroll', Widget_DCE_Dynamicposts_smoothscroll_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.smoothscroll', Widget_DCE_Dynamicposts_smoothscroll_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-search-results.smoothscroll', Widget_DCE_Dynamicposts_smoothscroll_Handler);
});
