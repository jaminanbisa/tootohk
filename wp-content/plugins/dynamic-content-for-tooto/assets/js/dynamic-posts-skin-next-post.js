var Widget_DCE_Dynamicposts_nextpost_Handler = function ($scope, $) {
    ...
    $scope.removeClass('tooto-widget-empty');
      ...
      if(use_template){
          jQuery.ajax({
                ...
                success: function (data, status, xhr) {
                    ...
                    var element_el = $result.find('.tooto-element');
...
jQuery(window).on('tooto/frontend/init', function () {
    ...
    tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.nextpost', Widget_DCE_Dynamicposts_nextpost_Handler);
