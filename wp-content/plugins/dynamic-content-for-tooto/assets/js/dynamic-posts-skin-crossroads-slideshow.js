...
jQuery(window).on('tooto/frontend/init', function () {
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.crossroadsslideshow', Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-woo-products-cart.crossroadsslideshow', Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.crossroadsslideshow', Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.crossroadsslideshow', Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.crossroadsslideshow', Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.crossroadsslideshow', Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-search-results.crossroadsslideshow', Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);
});
