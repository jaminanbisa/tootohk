...
const scene=new Scene()};$(window).on('tooto/frontend/init',function(){tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-bgcanvas.default',WidgetElements_BGCanvasHandler)})})(jQuery)