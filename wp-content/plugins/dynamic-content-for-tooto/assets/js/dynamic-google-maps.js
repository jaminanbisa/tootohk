...
(function ($) {
        ...
        function initMap(elements_map, mapParams_map) {
            ...
            if (elementSettingsMap.use_query) {
                ...
                if( elementSettingsMap.markerclustererControl ){
                    ...
                    {imagePath: '/wp-content/plugins/dynamic-content-for-tooto/assets/lib/gmap/markerclusterer/img/m'});
                }
    ...
    $(window).on('tooto/frontend/init', function () {
        ...
        tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-acf-google-maps.default', DyncontEl_GoogleMapsHandler);
    });
