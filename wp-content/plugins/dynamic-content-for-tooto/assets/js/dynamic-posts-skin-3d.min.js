...
function sfocaoggetto(object,animated=!1){var point1=camera.matrixWorld.getPosition().clone();var point2=object.position;var distance=(point1.distanceTo(point2)/distanza)-1;distance=distance*(3*distance);if(animated){gsap.to(object.element,{duration:0.6,webkitFilter:"blur("+distance.toFixed(2)+"px)",filter:"blur("+distance.toFixed(2)+"px)",})}else{gsap.set(object.element,{webkitFilter:"blur("+distance.toFixed(2)+"px)",filter:"blur("+distance.toFixed(2)+"px)",})}}};jQuery(window).on('tooto/frontend/init',function(){tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.3d',Widget_DCE_Dynamicposts_3d_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.3d',Widget_DCE_Dynamicposts_3d_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.3d',Widget_DCE_Dynamicposts_3d_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.3d',Widget_DCE_Dynamicposts_3d_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.3d',Widget_DCE_Dynamicposts_3d_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-search-results.3d',Widget_DCE_Dynamicposts_3d_Handler)})