...
var waypointOptions={offset:'100%',triggerOnce:!0};tootoFrontend.waypoint($(revealistance),runReveal,waypointOptions)}};$(window).on('tooto/frontend/init',function(){tootoFrontend.hooks.addAction('frontend/element_ready/global',WidgetElements_RevealHandler)})})(jQuery)