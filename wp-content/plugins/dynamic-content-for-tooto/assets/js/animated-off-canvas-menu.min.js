...
time_menu_list_opening=time_menu_list_opening/1000;var time_menu_list_stagger=Number(elementSettings.time_menu_list_stagger.size)/1000;var deviceMode=$('body').attr('data-tooto-device-mode');if(deviceMode=='tablet'&&rate_menuside_tablet){rate_menuside=rate_menuside_tablet}else if(deviceMode=='mobile'&&rate_menuside_mobile){rate_menuside=rate_menuside_mobile}
var close_menu=function(){tl.reversed(!tl.reversed());$(class_hamburger).find('.con').removeClass('actived').removeClass('open');if(!tootoFrontend.isEditMode()){$('body,html').removeClass('dce-modal-open')}};var tl=new gsap.timeline({paused:!0});tl.set(class_modal,{width:0,});if(side_background){if($(animatedoffcanvasmenu).find('dce-bg')){if(menu_position=='right'){tl.set(class_sidebg,{right:rate_menuside+'%',})}else{tl.set(class_sidebg,{left:rate_menuside+'%',})}}}
