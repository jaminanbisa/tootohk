...
(function ($) {
    ...
    var WidgetElementsPostsDCEHandler = function ($scope, $) {
        ...
        tootoElement = '.tooto-element-' + id_scope,
        ...
        if ($objBlock_acfposts.data('style') == 'grid') {
            ...
            // Swiper 4  (Non uso ancora per compatibilità con tooto)
            ...
            var swiperOptions = {
                ...
                loop: cicloInfinito,
                navigation: {
                    nextEl: id_post ? '.dce-tooto-post-' + id_post + ' .tooto-element-' + id_scope + ' .next-' + id_scope : '.next-' + id_scope,
                    prevEl: id_post ? '.dce-tooto-post-' + id_post + ' .tooto-element-' + id_scope + ' .prev-' + id_scope : '.prev-' + id_scope,
                },
                pagination: {
                    el: id_post ? '.dce-tooto-post-' + id_post + ' .tooto-element-' + id_scope + ' .pagination-' + id_scope : '.pagination-' + id_scope,
                    clickable: true,
            ...
            if (elementSettings.infiniteScroll_enable) {
                ...
                if (jQuery(tootoElement + ' .pagination__next').length) {
                    var infiniteScroll_options = {
                        ...
                        append: tootoElement + ' .dce-post-item',
                        outlayer: iso,
                    ...
                    $objBlock_acfposts.on( 'append.infiniteScroll', function( event, response, path, items ) {
						...
						if ( tootoFrontend) {
							if ( tootoFrontend.elementsHandler.runReadyTrigger ) {
								var widgets = $('.tooto-widget-dce-dyncontel-acfposts').find('.tooto-widget');
						...
						var allArticles = document.querySelectorAll(".tooto-widget-dce-dyncontel-acfposts .tooto-section, .tooto-widget-dce-dyncontel-acfposts .tooto-column");
    ...
    $(window).on('tooto/frontend/init', function () {
        ...
        tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-acfposts.default', WidgetElementsPostsDCEHandler);
    });
