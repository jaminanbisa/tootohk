...
$(window).on('tooto/frontend/init',function(){if(tootoFrontend.isEditMode()){isEditMode=!0}
if($('body').is('.admin-bar')){isAdminBar=!0}
tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-acf-google-maps.default',DyncontEl_GoogleMapsHandler)})})(jQuery);(function($){"use strict";$(function(){$(document).on("sf:ajaxfinish",".searchandfilter",function(e,data){if(tootoFrontend){if(tootoFrontend.elementsHandler.runReadyTrigger&&SF_LDATA.extensions.indexOf('search-filter-tooto')<0){tootoFrontend.elementsHandler.runReadyTrigger(data.targetSelector)}}})})}(jQuery))