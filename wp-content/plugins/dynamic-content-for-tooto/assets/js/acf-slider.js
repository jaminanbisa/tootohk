(function ($) {
    var WidgetElements_ACFSliderHandler = function ($scope, $) {
        ...
        var swiperOptions = {
            ...
            pagination: {
                el: id_post ? '.dce-tooto-post-' + id_post + ' .tooto-element-' + id_scope + ' .pagination-' + id_scope : '.pagination-' + id_scope, //'.swiper-pagination', //'.pagination-acfslider-'+id_scope,
                clickable: true,
    ...
    $(window).on('tooto/frontend/init', function () {
        tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-acfslider.default', WidgetElements_ACFSliderHandler);
    });
