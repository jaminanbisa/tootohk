...
jQuery(window).on('tooto/frontend/init', function () {
    tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.3d', Widget_DCE_Dynamicposts_3d_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.3d', Widget_DCE_Dynamicposts_3d_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.3d', Widget_DCE_Dynamicposts_3d_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.3d', Widget_DCE_Dynamicposts_3d_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.3d', Widget_DCE_Dynamicposts_3d_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-search-results.3d', Widget_DCE_Dynamicposts_3d_Handler);
});
