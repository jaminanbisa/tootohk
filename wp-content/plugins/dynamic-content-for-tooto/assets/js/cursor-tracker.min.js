...
if(tootoFrontend.isEditMode()&&$('body > .cursors').length){$('body > .cursors').remove()}
...
function o(t){t.addEventListener("mouseover",n),t.addEventListener("mouseout",s)}};$(".cursors").show();var responsive_cursorTracker=elementSettings.responsive_cursorTracker;var deviceMode=$('body').attr('data-tooto-device-mode');if($.inArray(deviceMode,responsive_cursorTracker)>=0){init_cursortracker()}else{cursorTarget.remove()}};$(window).on('tooto/frontend/init',function(){tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-cursorTracker.default',WidgetElements_CursorTrackerHandler)})})(jQuery)