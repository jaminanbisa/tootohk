...
jQuery(window).on('tooto/frontend/init', function () {
    tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.timeline', Widget_DCE_Dynamicposts_timeline_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.timeline', Widget_DCE_Dynamicposts_timeline_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.timeline', Widget_DCE_Dynamicposts_timeline_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.timeline', Widget_DCE_Dynamicposts_timeline_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-search-results.timeline', Widget_DCE_Dynamicposts_timeline_Handler);
	tootoFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.timeline', Widget_DCE_Dynamicposts_timeline_Handler);
});
