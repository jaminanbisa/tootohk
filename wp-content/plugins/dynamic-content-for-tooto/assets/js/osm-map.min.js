jQuery(window).on('tooto/frontend/init',()=>{class OsmMap extends tootoModules.frontend.handlers.Base{getDefaultSettings(){return{selectors:{mapWrapper:'.dce-osm-wrapper',},}}
...
const addHandler=($element)=>{tootoFrontend.elementsHandler.addHandler(OsmMap,{$element,})};tootoFrontend.hooks.addAction('frontend/element_ready/dce-osm-map.default',addHandler)})