...
if(!1===tootoFrontend.isEditMode()&&'yes'===elementSettings.templatemode_linkable){$scope.find('.dce-post.dce-post-item[data-post-link]').click(function(){window.location.assign($(this).attr("data-post-link"));return!1})}
...
if(attribute_of_target=='none'){toggleRatio()}}}};observe_Dyncontel_element($scope[0],Dyncontel_MutationObserverCallback)};jQuery(window).on('tooto/frontend/init',function(){tootoFrontend.hooks.addAction('frontend/element_ready/widget',Widget_DCE_Dynamicposts_base_Handler)});(function($){"use strict";$(function(){$(document).on("sf:ajaxfinish",".searchandfilter",function(e,data){if(tootoFrontend){if(tootoFrontend.elementsHandler.runReadyTrigger&&SF_LDATA.extensions.indexOf('search-filter-tooto')<0){tootoFrontend.elementsHandler.runReadyTrigger(data.targetSelector)}}})})}(jQuery))