...
if($('.dg').length)$('.dg').empty();let sketch=new Sketch({content:contentDistortion[0],container:containerDistortion[0],debug:!1,duration:speedDistortion,uniforms:uniform_selected,fragment:fragment_selected})};$(window).on('tooto/frontend/init',function(){tootoFrontend.hooks.addAction('frontend/element_ready/dyncontel-imagesDistortion.default',WidgetElements_imagesDistortionHandler)})})(jQuery)