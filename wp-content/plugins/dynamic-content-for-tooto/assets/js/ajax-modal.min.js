...
function requestContent(file){jQuery('.content').load(file+' .content')}(function($){$(window).on('tooto/frontend/init',function(){if(jQuery('.ajax-open').length>0){jQuery('.ajax-open').each(function(i,el){var elementSettings_ajaxOpen=get_Dyncontel_ElementSettings(jQuery(this));ajaxPage_init(elementSettings_ajaxOpen,jQuery(this).attr('data-id'))})}})})(jQuery)