...
const revealer=new Revealer(document.querySelector('.dce-revealer__inner'));new Slideshow(document.querySelector('.dce-grid--slideshow'));imagesLoaded(document.querySelectorAll('.dce-img'),{background:!0},()=>document.body.classList.remove('loading'));[...document.querySelectorAll('.frame__mode input[type="radio"]')].forEach(radio=>radio.addEventListener('click',()=>{document.body.classList[radio.parentNode.classList.contains('frame__mode-item--dark')?'add':'remove']('dark-mode')}))};jQuery(window).on('tooto/frontend/init',function(){tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.crossroadsslideshow',Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-woo-products-cart.crossroadsslideshow',Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.crossroadsslideshow',Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.crossroadsslideshow',Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.crossroadsslideshow',Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.crossroadsslideshow',Widget_DCE_Dynamicposts_crossroadsslideshow_Handler);tootoFrontend.hooks.addAction('frontend/element_ready/dce-search-results.crossroadsslideshow',Widget_DCE_Dynamicposts_crossroadsslideshow_Handler)})