...
class SwiperBase{
    ...
    constructor(data, wid, scope = null) {
        ...
        let swiper = [];
        let swiperContainer = '.tooto-element-' + wid + ' .ae-swiper-container';
        let active_breakpoints = tootoFrontend.config.responsive.activeBreakpoints;
        if (scope !== null) {
            wid = scope.data('id');
           // console.log(wid);
            const slideId = scope.find('.swiper-container').data('ae-slider-id');
            swiperContainer = '.tooto-element-' + wid + ' .ae-swiper-container[data-ae-slider-id="' + slideId + '"]'
        }
        const wclass = '.tooto-element-' + wid;
        ...
        if ('undefined' === typeof Swiper) {
            ...
            new asyncSwiper( jQuery( swiperContainer ), swiper).then((newSwiperInstance) => {
                ...
                tootoFrontend.hooks.doAction( `aepro/trigger/swiper/widget/${wid}`, mswiper);
            });
        } else {
            
            const mswiper = new Swiper('.tooto-element-' + wid + ' .ae-swiper-container', swiper);
        ...
        jQuery('.tooto-element-' + wid + ' .ae-swiper-container').css('visibility', 'visible');
        ...
        if (mswiper.length > 0) {
                ...
                mswiper.forEach(function (slider) {
                    ...
                    slider.on('slideChangeTransitionStart', function () {
                        ...
                        slider.$wrapperEl.find('.swiper-slide-duplicate').find('.tooto-invisible').each(function () {
                            // get settings
                ...
                mswiper.on('slideChangeTransitionStart', function () {
                    ...
                    // reveal animated widgets
                    mswiper.$wrapperEl.find('.swiper-slide-duplicate').find('.tooto-invisible').each(function () {
                        // get settings
                         tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                    });
    ...
    pause_on_hover_func(mswiper, pause_on_hover, wid) {
        jQuery('.tooto-element-' + wid + ' .ae-swiper-container').hover(function () {
...
const BgSliderHandler = ( $scope , $ ) => {
    ...
    if ($scope.children('.aepro-section-bs').children('.aepro-section-bs-inner').hasClass('edit-mode')) {
        ...
        if (ae_slider_id) {
            slider_wrapper = jQuery(".tooto-element-" + wid + "[data-ae_slider='" + ae_slider_id + "']").children('.aepro-section-bs').children('.aepro-section-bs-inner');
...
const DynamicBgHandler = function ($scope, $) {
    ...
    if ($scope.hasClass("tooto-element-edit-mode")) {
        var data = {
...
( function( $ ) {
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/global', DynamicBgHandler);
    });
})(jQuery);
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-acf-flexible-content.carousel', AcfFlexibleCarousel);
    });
})( jQuery );
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-acf-flexible-content.grid', AcfFlexibleGrid);
    });
})( jQuery );
...
( function( $ ) {
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-acf-gallery.carousel', 	 ACFGalleryCarousel );
    });
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        ...
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-acf-gallery.grid', ACFGalleryGrid);
    });
})(jQuery);
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-acf-gallery.justified', ACFGalleryJustified);
    });
})(jQuery);
...
(function($){
    const ACFGallerySmartGrid = ( $scope , $ ) => {
        ...
        if ($scope.find('.ae-acf-gallery-layout-smart-grid')) {
            ...
            if (($('body').data('tooto-device-mode') == 'tablet' || $('body').hasClass('tooto-device-tablet'))
                || ($('body').data('tooto-device-mode') == 'mobile' || $('body').hasClass('tooto-device-mobile'))) {
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-acf-gallery.smart_grid', ACFGallerySmartGrid);
    });
})(jQuery);
...
(function($){
    ...
    const ACFRepeaterAccordionHandler = ($scope, $) => {
        ...
        const title = $scope.find('[data-tab-id="' + tid + '"] > .ae-accordion-item > .tooto-tab-title.ae-tab-title');
        ...
        (title).on('click', function (e) {
            ...
            if ($this.hasClass("ae-active")) {
                ...
                $this
                    .parent()
                    .parent()
                    .find(".tooto-tab-title.ae-tab-title")
                ...
                $this.next().slideDown(speed, 'linear', function () {
                    ...
                    /* $this.next().find('.tooto-section').each(function () {
                        tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                    });

                    $this.next().find('.tooto-column').each(function(){
                        tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                    });
                    
                    $this.next().find('.tooto-widget').each(function(){
                        tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                    }); */
                });
            }
            ...
            // setTimeout(function () {
               ...
               /*  $this.siblings('.ae-tab-content').find('.tooto-widget-ae-acf-gallery').each(function () {
                    tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                });
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-acf-repeater.accordion',  ACFRepeaterAccordionHandler );
    });
...
( function( $ ) {
    ...
    const ACFRepeaterDefaultHandler = ($scope, $) => {
        ...
        if (_base__WEBPACK_IMPORTED_MODULE_0__["isEditMode"]) {
            const sections = $scope.find('.tooto-section');
            $.each(sections, function (key, $section) {
                Object(_dynamic_bg__WEBPACK_IMPORTED_MODULE_1__["default"])($($section), $);
            });

            const columns = $scope.find('.tooto-column');
    ...
    $(window).on('tooto/frontend/init', function () {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-acf-repeater.default', ACFRepeaterDefaultHandler);
    });
})(jQuery);
...
(function($){
    ...
    const tabsLoad = ($scope, $) => {
        ...
        if (document.body.dataset.tootoDeviceMode == 'mobile') {
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-acf-repeater.tabs',   ACFRepeaterTabsHandler );
    });
})(jQuery);
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-acf.wysiwyg', FoldToUnfold );
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-acf.text-area',   FoldToUnfold );
    });
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-taxonomy-blocks.term_post_loop', AeTaxonomyBlocksAccordionHandler);
    });
})(jQuery);
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-taxonomy-blocks.card', AeTaxonomyBlocks);
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-taxonomy-blocks.classic', AeTaxonomyBlocks);
    });
})(jQuery);
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-cf-google-map.default', 	CFGoogleMap );
    });
})(jQuery);
...
(function($){
    ...
    const CustomFieldHandler = function ( $scope , $ ) {
        ...
        if($scope.find('.ae-cf-wrapper').hasClass('hide')){
            $scope.find('.ae-cf-wrapper').closest('.tooto-widget-ae-custom-field').hide();
        }
    };

    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-custom-field.default', CustomFieldHandler );
    });
...
(function($){
    const AeDynamicCalendar = ($scope, $) => {
        ...
        if (tootoFrontend.isEditMode() || settings.listing_render == 'load') {
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-dynamic-calendar.skin_1', AeDynamicCalendar);
    });
})(jQuery);
...
(function ($) {
        ...
        if ($scope.find('.ae-dynamic-map-wrapper').length) {
                ...
                marker_item.forEach(node => {
                    node.addEventListener('click', function (el) {
                        ...
                        if (document.querySelector(wclass + ' .ae-responsive-btn')) {
                            if (document.querySelector(wclass + ' .ae-listing-responsive-mode-yes.' + document.querySelector('body').dataset.tootoDeviceMode)) {
            ...
            if (document.querySelector(wclass + ' .ae-dynamic-map-wrapper').dataset.map_type === 'google_map') {
                ...
                const add_marker = ($marker_div, map) => {
                    ...
                    let icon = '<div class="ae-map-marker" id="temp"><img src="/wp-content/plugins/anywhere-tooto-pro/includes/assets/images/map-icon.png" /></div>';
                    ...
                    if ($marker_div.html()) {
                        ...
                        google.maps.event.addListener(marker, 'click', function (i) {
                            ...
                            if (settings['marker_click_action'] == 'info_window') {
                                ...
                                $scope.find('.tooto-widget').each(function () {
                                    tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                                });
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-dynamic-map.default', DynamicMap );
    });
})(jQuery);
...
( function( $ ) {
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-pods.file_gallery', PodsGallery );
    });
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-portfolio.default', PortfolioHandler );
    });
...
( function( $ ) {
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-post-blocks-adv.carousel', 	PostBlocksAdvHandler );
    });
...
(function($){
        ...
        (collapse_button).on('click',function(e){
            ...
            if(acc_status == role){
                ...
                title.each(function (index, element) {
                    ...
                    var content = $(element).next();
                    content.slideUp(speed);
                    //content.removeClass('tooto-active');
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-post-blocks-adv.accordion',  PostBlockAdvAccordionHandler );
    });
...
(function ($) {
        ...
        ias.on('append.infiniteScroll', function(event, response, path, items) {
            ...
            $scope.find('.ae-post-collection').find('.ae-cf-wrapper').each(function() {
                if ($(this).hasClass('hide')) {
                    $(this).closest('.tooto-widget-ae-custom-field').hide();
                }
            });
            ...
            /* Initialise ACF Gallery on Ajax */
           /*  $scope.find('.ae-post-item.appended .tooto-widget-ae-acf-gallery').each(function () {
                tootoFrontend.elementsHandler.runReadyTrigger($(this));
            }); */

            $scope.find('.ae-post-item.appended .tooto-section').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });

            $scope.find('.ae-post-item.appended .tooto-column').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
            
            $scope.find('.ae-post-item.appended .tooto-widget').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
        });
    ...
    const PostBlocksAdvHandler = ($scope, $) => {
        ...
        var device_mode = jQuery('body').data('tooto-device-mode');

        //tooto Editor
        if (tootoFrontend.isEditMode()) {
            device_mode = tooto.channels.deviceMode.request('currentMode');
            var filter = $scope.find('.aep-filter-bar.' + device_mode);
            $scope.find('.aep-filter-bar').hide();
            filter.show();
            tooto.channels.deviceMode.on('change', function(){
                device_mode = tooto.channels.deviceMode.request('currentMode');
        ...
        let $hashtag = window.location.hash.substring(1);
        if ($hashtag) {
            let device = jQuery('body').data('tooto-device-mode');
    ...
    $(document).on('click', '.facetwp-template.tooto-widget-ae-post-blocks-adv .ae-pagination-wrapper a', function(e) {
        e.preventDefault();
    ...
    if(jQuery('.ae-outer-wrapper').parents('.facetwp-template ').length > 0 ) {
        ...
        $(document).on('facetwp-loaded', function () {
            var widget_wrapper = jQuery('.facetwp-template.tooto-widget-ae-post-blocks-adv');
            var wrapper = jQuery('.ae-outer-wrapper');
            var ae_post_overlay = wrapper.siblings('.ae-post-overlay');
            if(wrapper.data('item-reveal-animation') == 'yes') {
                ...
                setTimeout(function () {
                    ...
                    wrapper.find('.ae-cf-wrapper.hide').each(function () {
                        jQuery(this).closest('.tooto-widget-ae-custom-field').hide();
                    });
                    ...
                    wrapper.find('.tooto-invisible').each(function () {
                        // get settings
                        settings = jQuery(this).data('settings');
                        animation = settings.animation || settings._animation;

                        jQuery(this).removeClass('tooto-invisible').removeClass(animation).addClass(animation);
                    ...
                    if (disable_scroll_on_ajax_load == 'no') {
                        if (facetWP_flag) {
                           var settings = widget_wrapper.data('settings');
                            ...
                            if (document.body.dataset.tootoDeviceMode != 'desktop') {
                                pagination_scroll_top_offset = settings['grid_pagination_scroll_top_offset_' + document.body.dataset.tootoDeviceMode]['size'];
                            }
    ...
    if ($('.searchandfilter').length > 0) {
        $(document).on("sf:ajaxfinish", ".searchandfilter", function () {
            ...
            wrapper.find('.tooto-section').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });

            wrapper.find('.tooto-column').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
            
            wrapper.find('.tooto-widget').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
        });
    }
...
(function($){
    ...
    const PostBlocksAdvTabsHandler = ( $scope, $ ) => {
        ...
        $tabsTitles.on( 'click', function() {
            ...
            /* Initialise ACF Gallery on Ajax */
            $tabs.find('.tooto-widget-ae-acf-gallery').each(function () {
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
        });
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-post-blocks-adv.tabs',   PostBlocksAdvTabsHandler );
    });
})(jQuery);
...
( function( $ ) {
    ...
    const _ias =  ( $scope , $, grid ) => {
        ...
        ias.on('append.infiniteScroll', function(event, response, path, items) {
            ...
            /* Initialise ACF Gallery on Ajax */
           /*  $scope.find('.ae-post-list-item.appended .tooto-widget-ae-acf-gallery').each(function () {
                tootoFrontend.elementsHandler.runReadyTrigger($(this));
            }); */

            $scope.find('.ae-post-list-item.appended .tooto-section').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });

            $scope.find('.ae-post-list-item.appended .tooto-column').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
            
            $scope.find('.ae-post-list-item.appended .tooto-widget').each(function(){
                tootoFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-post-blocks.default', 	PostBlocksHandler );
    });
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-post-content.default',    ContentUnfold );
    });
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-post-image.default',  PostImageHandler );
    });
...
(function ($) {
        ...
        jQuery.each(trigger_targets, function (i, trigger_target) {
            ...
            Array.from(wrapper).forEach((el) => {
                ...
                if (trigger_data.trigger_type == 'carousel') {
                    let $mswiper = document.querySelector('.tooto-element-' + trigger_target + ' .ae-swiper-container').swiper;
                ...
                if (trigger_data.trigger_type == 'carousel') {
                    ...
                    switch (trigger_data.trigger_action) {
                        ...
                        case 'first_slide':
                            ...
                            break;
                        case 'last_slide':
                            var totalSlides = $('.tooto-element-' + trigger_target + ' .ae-swiper-container .swiper-slide:not(.swiper-slide-duplicate)').length;
            ...
            //For Accordions
            const accordion = $('.tooto-element-' + trigger_target);
            ...
            $scope.find('.ae-trigger').on('click', function (e) {
                ...
                if (trigger_data.trigger_type == 'accordion') {
                    $scope.find('.ae-triggers').removeClass('active');
                    $this.parent('.ae-triggers').addClass('active');
                    const el_target = $('.tooto-element-' + trigger_target);
                    const title = $('.tooto-element-' + trigger_target + ' .ae-tab-title');
                    var content = $('.tooto-element-' + trigger_target + ' .ae-tab-content');
                    const speed = $scope.find('.ae-accordion').data('transition-speed');
                    switch (trigger_data.trigger_action) {
    ...
    $(window).on('load', function () {
        const widget_triggers = $('.tooto-widget-ae-trigger');
...
( function( $ ) {
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-woo-products.carousel', 	 WooProductCarousel );
    });
...
var WooProductImgeGallery = function ( $scope, $ ) {
    ...
    if($scope.parents('.tooto-editor-active').length){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction('frontend/element_ready/ae-woo-gallery.default', WooProductImgeGallery);
    });
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-woo-products.grid',   WooProductsGrid );
    });
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-woo-rating.default',  WooRatingHandler );
    });
...
(function($){
    ...
    $(window).on( 'tooto/frontend/init', function() {
        tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-woo-tabs.default', WooTabsHandler );
    });
