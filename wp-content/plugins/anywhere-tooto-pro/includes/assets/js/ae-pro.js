jQuery(document).on('tooto/render/cf-video',function(e,id,a_ratio){
    container_element = '.tooto-element-'+ id;
    iframe_element = '.tooto-element-' + id + ' .cf-type-video iframe';
...
jQuery(document).on('click','.tooto-widget-ae-post-blocks .ae-pagination-wrapper a',function(){
    var widget_wrapper = jQuery(this).closest('.tooto-widget-ae-post-blocks');
    ...
    var e_wrapper = wrapper.closest('.tooto').attr('class');
...
jQuery(document).on('click','.tooto-widget-ae-portfolio .ae-pagination-wrapper a, .tooto-widget-ae-portfolio .filter-items a',function(){
    var page_num = 1;
    var wrapper = jQuery(this).closest('.ae-post-widget-wrapper');
    ...
    //pid = e_wrapper.split('-')[1];
    pid = wrapper.closest('.tooto').data('tooto-id');
...
(function ($) {
    ...
    $(document).on('click', '.facetwp-template.tooto-widget-ae-post-blocks .ae-pagination-wrapper a', function(e) {
        e.preventDefault();
        var wrapper = jQuery(this).closest('.ae-post-widget-wrapper');
        var ae_post_overlay = wrapper.siblings('.ae-post-overlay');
...
jQuery(document).on('click','.tooto-widget-ae-post-blocks-adv .ae-pagination-wrapper a, .tooto-widget-ae-post-blocks-adv .filter-items a',function(){

    var widget_wrapper = jQuery(this).closest('.tooto-widget-ae-post-blocks-adv');
        ...
        success: function (res) {
            ...
            if(wrapper.data('item-reveal-animation') == 'yes'){
                ...
                setTimeout( function(){
                    ...
                    var device = jQuery('body').data('tooto-device-mode');
...
jQuery(document).on('click', '.tooto-widget-ae-dynamic-calendar #ae-dynamic-calendar .ae-dc-prev', ae_dynamic_calendar_prev_month);
jQuery(document).on('click', '.tooto-widget-ae-dynamic-calendar #ae-dynamic-calendar .ae-dc-next', ae_dynamic_calendar_next_month);

function ae_dynamic_calendar_prev_month(e) {
    e.preventDefault();
    var widget_wrapper = jQuery(this).closest('.tooto-widget-ae-dynamic-calendar');
    var wrapper = jQuery(widget_wrapper).find('.ae-outer-wrapper');
...
function ae_element_reinitialize(wrapper) {
    ...
    /* wrapper.find('.tooto-widget-ae-acf-gallery').each(function(){
