jQuery(document).ready(function () {
	...
	tooto.hooks.addAction('panel/open_editor/widget/ae-post-blocks-adv', get_ae_widget_id);
	tooto.hooks.addAction('panel/open_editor/widget/ae-post-blocks', get_ae_widget_id);
	tooto.hooks.addAction('panel/open_editor/widget/ae-acf-repeater', get_ae_widget_id);
	tooto.hooks.addAction('panel/open_editor/widget/ae-acf-gallery', get_ae_widget_id);
	tooto.hooks.addAction('panel/open_editor/widget/ae-acf-flexible-content', get_ae_widget_id);
	...
	tooto.hooks.addAction('panel/open_editor/widget', function (panel, model, view) {
        ...
        if(widget_type == 'ae-acf'){
            jQuery('.tooto-control-_skin label').html('Field Type');
        }
		...
		if (widget_type == 'ae-post-blocks-adv') {
			jQuery('.tooto-control-_skin label').html('Layout');
...
(function (tooto, $, window) {
	// Query Control
	console.log(tooto.modules.controls);
	var Raw_Html = tooto.modules.controls.Wysiwyg.extend({
	...
	tooto.addControlView( 'aep-raw-html', Raw_Html );

	var Query = tooto.modules.controls.Select2.extend({
		cache: null,
	...
	tooto.addControlView( 'aep-query', Query );
