...
( function( $ ) {
    ...
    var WooProductsCarousel = function ( $scope , $ ) {
        ...
        window.mswiper = new Swiper( '.tooto-element-' + wid  + ' .ae-swiper-container', adata);
        $('.tooto-element-' + wid  + ' .ae-swiper-container').css('visibility','visible');
    };
    ...
    $(window).on( 'tooto/frontend/init', function() {
       ...
       // tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-woo-gallery.default', 	WooGalleryHandler );

        //tootoFrontend.hooks.addAction( 'frontend/element_ready/ae-woo-products.carousel', 	WooProductsCarousel );
