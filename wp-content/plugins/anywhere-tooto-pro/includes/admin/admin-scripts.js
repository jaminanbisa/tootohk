 ...
 */
    ...
    jQuery('#tooto-hidden-area.ae-import-form').show();
    ...
    if (currentUrlParams.get('ae_import_template')) {
        ...
        jQuery('.ae-import-form #tooto-import-template-area').toggleClass('show');
    }
...
( function( $ ) {
    ...
    $(window).on('load', function(){
		...
		if(param == 1){ console.log('in if');
			jQuery('.activate-license.anywhere-tooto a').click();
		}
